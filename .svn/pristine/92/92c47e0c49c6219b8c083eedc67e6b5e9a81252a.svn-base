        ...
        <div class="listBox2 thBg">
            ...
            <table class="table-horizontal">
                ...
                <tr>
                    ...
                    <td width="180">
                        <div class="ipt-box"><input class="laydate-icon view-opadetail" type="text" disabled="disabled"
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <div class="radio-box" id="unusualRadio">
                            <label class="font-12"><input type="radio" class="view-opadetail" name="auditOpinselect" id="yes" value="1" disabled="disabled"
                                          <c:if test="${pubOpaDetail.auditState == '1'}">checked</c:if> />${pubOpaDetail.isMove == '1' ? '予以移出经营异常名录' : '予以更正（撤销）'}</label>
                            <label class="font-12"><input type="radio" class="view-opadetail" name="auditOpinselect" id="no" value="2" disabled="disabled"
                        ...
                        <div class="ipt-box">
                            <textarea id="auditOpin" name="auditOpin"
                                  class="txt_1 view-opadetail" readonly="readonly">${pubOpaDetail.auditOpin}</textarea>
                        </div>
                    </td>
                </tr>
