...
/**
 * 描述:    cs_rpt_yr_Amount 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2017年01月18日
 */
@Table(name = "cs_rpt_yr_Amount")
public class YrAmountRpt implements Serializable {
    /**
     * 地区编码
     */
