require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initDataTable() {
        table = dataTable.load({
            ...
            scrollX: true,
            ajax: {
                url:'/syn/pub/server/drcheck/pubscinfo/listauth.json',
                data:function(d){
            ...
            columnDefs: [{
    	        ...
    	        render:function(data,type,row,meta){
	        		return "<a class='commit js_view' href='javascript:void(0)'>查看</a>";
    	       }
	        },{
            	targets:2,
    	        render:function(data,type,row,meta){
        ...
        util.bindEvents([{
            ...
            handler: function () {
                ...
                layer.dialog({
                    title: '',
                    area: ['95%', '95%'],
                    content: '/syn/pub/server/drcheck/pubscinfo/search?taskNO='+data.taskNO+"&priPID="+data.priPID,
