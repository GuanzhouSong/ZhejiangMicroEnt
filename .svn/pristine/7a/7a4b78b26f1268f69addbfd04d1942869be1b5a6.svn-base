    ...
    <form id="taskForm" class="form-box">
        <div class="form-list">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    <label class="item-name col-5">入库状态：</label>
                    <div class="col-7">
                        <div class="ipt-box col-11">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            ...
                            <input type="text" class="ipt-txt" id="partyOrgName" readonly="readonly" placeholder="请选择党组织"/>
...
<div class="iframe-wrap">
    <button type="button" id="addBtn" class="btn btn-primary mt5">新增党员</button>
    <div class="light-info mb5 mt5">
        <span class="light">提示：新增党员信息在入库前可删除，入库后即为建档信息只能修改。 <i class="light-box-y mr5"></i>表示党员所在的企业登记状态异常。 </span>
    </div>
...
<script src="/js/reg/server/partycreate/party_member_add_list.js"></script>
</body>
</html>
