...
<div class="form-box mb5">
    <form id="scinforesultform">
        <input type="hidden" id="" name="auditType" value="audit"/>
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt" readonly="readonly" id="regOrgName" value=""
                                   placeholder="选择"/>
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <div class="col-8">
                        ...
                        <div class="ipt-box col-5">
                            <input type="text" class="ipt-txt" readonly="readonly" name="endDate" onclick="laydate()"/>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" id="leaderDeptName" readonly="readonly" value="" class="fl ipt-txt"
                                   placeholder="选择">
...
<script src="/js/syn/system/drcheck/pubscinforesultaudit_list.js"></script>
</body>
</html>