require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initDataTable() {
     	 var url=_sysUrl+'/pubdzdtinfo/pubdzdtinfoFailReBackListJSON.json';
        ...
        util.bindEvents([{
            ...
            handler: function () {
                ...
                layer.dialog({
                    title: '涉证企业分流',
                    area: ['90%', '90%'],
                    content: _sysUrl+'/pubdzdtinfo/pubdtinfoHandPush?uid='+radioArr[0].value,
        ...
        },
        {
            ...
            handler: function () { 
            	 layer.dialog({
                     title: '手动触发分流',
                     area: ['50%', '40%'],
                     content: '/quartz/pubDzDtInfoPush/pubdtinfoMaintainPush',
                     callback: function (data) { 
        ...
        },
        {
            ...
            handler: function () { 
                layer.dialog({
                    title: '选择备案事项',
                    area: ['400px', '600px'],
                    content: _sysUrl+'/pubdzdtinfo/codeLicenseCheckboxTreePage',
                    callback: function (data) { 
