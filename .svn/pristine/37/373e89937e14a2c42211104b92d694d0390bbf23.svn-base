        ...
        table = dataTable.load({
            ...
            columnDefs: [{
    	        ...
    	        render:function(data,type,row,meta){
    	        	if(data.auditState == null || data.auditState == "" || data.auditState == "0" ||  data.auditState == "5"){
    	        		return  "<a class='commit js_view' href='javascript:void(0)'>填写</a>";
    	        	}else{
    	        		return "<a class='commit js_view' href='javascript:void(0)'>修改</a>";
    	        	}
    	       }
	        },{
            	targets:2,
        ...
        util.bindEvents([{
            ...
            handler: function () {
                ...
                layer.dialog({
                    title: '',
                    area: ['95%', '95%'],
                    content: '/syn/pub/server/drcheck/pubscinfo/edit?taskNO='+data.taskNO+"&priPID="+data.priPID,
