        ...
        <form id="pre_form">
            ...
            <div class="form-item clearfix pd50">
                ...
                <div class="col-5">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" readonly="readonly" style="background-color: #f4f4f4;" value="<fmt:formatDate value="${partyActivityInfoDto.requireEndDate}" type="date" pattern="yyyy-MM-dd"/>" >
                        </div>
                    </div>
                </div>
            </div>            
            ...
            <div class="form-item clearfix pd50">
                <div class="col-12">
                    ...
                    <div class="w854">
                        <div class="ipt-box col-12">
                            <textarea class="wfss-tt1" name="" cols="30" rows="10" readonly="readonly" style="background-color: #f4f4f4;">${partyActivityInfoDto.activityContent}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-item clearfix pd50" ${partyActivityInfoDto.inputState == '1' ? "style ='display:none;'" : ""  } >
                <div class="col-12">
                    <label class="item-name w146" >活动接收部门：</label>
                    <div class="w854">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" readonly="readonly" style="background-color: #f4f4f4;" value="${partyOrganizeInfo.partyOrgName}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-item clearfix pd50" ${partyActivityInfoDto.inputState == '1' ? "style ='display:none;'" : ""  } >
                <div class="col-7">
                    ...
                    <div class="col-9">
                        <div class="ipt-box col-12">
                            <input style="background-color: #f4f4f4;" readonly="readonly" type="text" class="ipt-txt clx" name="inputName" value="${partyActivityInfoDto.inputName}">
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    ...
                    <div class="col-9">
                        <div class="ipt-box col-12">
                            <input style="background-color: #f4f4f4;" readonly="readonly" type="text"  class="ipt-txt clx" name="inputDate" value="<fmt:formatDate value="${partyActivityInfoDto.inputDate}" type="date" pattern="yyyy-MM-dd"/>">
                        </div>
                    </div>
                </div>
            </div>
           </form>           			
           <form id="content_form" ${partyActivityInfoDto.inputState == '0' ? "style ='display:none;'" : ""  }>
            ...
            <div class="form-item clearfix pd50">
                <div class="col-7">
                    ...
                    <div class="col-9">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" readonly="readonly" style="background-color: #f4f4f4;" id="activityPlace" name="activityPlace" value="${partyActivityInfoDto.activityPlace}">
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt clx" id="claimDeptName" name="claimDeptName" value="${partyOrganizeInfo.partyOrgName}" readonly="readonly" style="background-color: #f4f4f4;">
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="col-7">
                    ...
                    <div class="col-9">
                        <div class="ipt-box col-11">
                            <input type="text" class="ipt-txt zxyxq-btn clx" id="activitybeginDate" name="activitybeginDate" readonly="readonly" style="background-color: #f4f4f4;" value="<fmt:formatDate value="${partyActivityInfoDto.activitybeginDate}" type="date" pattern="yyyy-MM-dd"/>">
                            <span class="date-middle-line"></span>
                            <input type="text" class="ipt-txt zxyxq-btn clx" id="activityEndDate" name="activityEndDate" readonly="readonly" style="background-color: #f4f4f4;" value="<fmt:formatDate value="${partyActivityInfoDto.activityEndDate}" type="date" pattern="yyyy-MM-dd"/>">
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt clx" name="claimLocalAdmName" id="claimLocalAdmName" value="${partyOrganizeInfo.localAdmName}" readonly="readonly" style="background-color: #f4f4f4;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-item clearfix pd50">
                <div class="col-7">
                    ...
                    <div class="col-9">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" id="originator" name="originator" value="${partyActivityInfoDto.originator}" readonly="readonly" style="background-color: #f4f4f4;">
...
<!--                             <span class="add-icon" id="chooseoriginator"><i></i></span> -->
                ...
                <div class="col-5">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" id="joinNum" name="joinNum" readonly="readonly" style="background-color: #f4f4f4;" value="${partyActivityInfoDto.joinNum}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-item clearfix pd50">
                <div class="col-12">
                    ...
                    <div class="w854">
                        <div class="ipt-box col-12">
                            <textarea class="wfss-tt1" id="joiner" name="joiner" cols="30" rows="10" readonly="readonly" disabled>${partyActivityInfoDto.joiner}</textarea>
...
<!--                         </div> -->
            ...
            <div class="form-item clearfix pd50">
                <div class="col-12">
                    ...
                    <div class="w854">
                        <div class="ipt-box col-12">
                            <textarea class="wfss-tt1" disabled name="activitySituation" id="activitySituation" maxlength="500" cols="30" rows="10">${partyActivityInfoDto.activitySituation}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-item clearfix mb5 pd50">
                <div class="col-12">
                    ...
                    <div class="w854">
                        <div class="ipt-box col-12" id="filelabel">
...
<%--                             <input type="hidden" name="resultInputCode" id="resultInputCode"  value="${sysUser.id}" /> --%>
                            <input type="text" class="ipt-txt clx" readonly="readonly" style="background-color: #f4f4f4;" name="resultInputName" value="${partyActivityInfoDto.resultInputName}">                       
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" readonly="readonly" style="background-color: #f4f4f4;" name="resultInputDate" value="<fmt:formatDate value="${partyActivityInfoDto.resultInputDate}" type="date" pattern="yyyy-MM-dd"/>">
                        </div>
                    </div>
                </div>
            </div>          
