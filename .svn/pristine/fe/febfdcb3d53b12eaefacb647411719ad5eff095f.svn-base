    ...
    <div class="form-list">
        ...
        <div class="form-item clearfix">
            <div class="btn-box">
                ...
                <input type="button" value="更多查询添加" class="btn">
            </div>
        </div>
    </div>
</div>
<div class="clearfix mb5 mt20">
    <p class="fl"><input type="button" class="btn btn-sm mr5" value="返回"><input type="button" class="btn btn-sm mr5" value="增加行政指导"><input type="button" class="btn btn-sm" value="导出"></p>
</div>
<div>
