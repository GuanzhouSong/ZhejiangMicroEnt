...
//        initDataTable();
    ...
    function initDataTable() {
        ...
        table = dataTable.load({
            ...
            ajax: {
                url:window._CONFIG.chooseUrl+'/server/opanomaly/pbopanomaly/pbopanomalySearchList.json',
                data:function(d){
            ...
            handler: function () {
            	var data = table.row($(this)).data();
                 layer.dialog({
                    title: '经营异常状态查询详情',
                    area: ['1024px', '500px'],
                    content: window._CONFIG.chooseUrl+'/server/opanomaly/pbopanomaly/pbopanomalySearchViewPage?busExcList='+data.busExcList,
