...
<body class="pd10">
	  <div class="main">
		...
		<form id="pubopadetailform"  >
             ...
             <input type="hidden" name="abnTime" id="sendabnTime" value="${pubOpanoMaly.abnTime}"> 
             ...
             <input type="hidden" name="isMove" value="2">
             ...
             <input type="hidden" name="deptName" value="${departMent.deptName}">
             <input type="hidden" name="deptUpName" value="${departMent.deptUpName}">
             <input type="hidden" name="deptSameCourt" value="${departMent.sameCourt}">
             <input type="hidden" name="deptSameGov" value="${departMent.sameGov}">
        	...
        	<div class="listBox2 thBg">
                    ...
                    <table class="table-horizontal">
                        ...
                        <tr>
                            ...
                            <td colspan="5"><div class="ipt-box"><textarea id="firstOpin" name="firstOpin" class="txt_1" >${pubOpaDetail.firstOpin == null ? '拟予以更正（撤销）异常名录信息。' : pubOpaDetail.firstOpin}</textarea></div>
                            </td>
                        </tr>
                        <tr>
                        	<td class="bg-gray right" valign="middle" class="lb_1" style="text-align:center"><div class="ipt-box">作出决定日期</div></td>
                            <td width="180"><div class="ipt-box"><input class="laydate-icon" type="text" style="width: 150px;cursor: pointer;"  name="remDate" readonly="readonly" id="remDate" value="" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" /></div></td>
                            <td colspan="2"><div class="ipt-box" style="color:red;">注：局领导已在纸质材料上审批的，请录入领导审批日期，若尚未审批可不填写。</div></td>
...
<script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopadetail/pubopadetailaddcancel_edit.js"/>"></script> </body>
<script>
    window._CONFIG = {
