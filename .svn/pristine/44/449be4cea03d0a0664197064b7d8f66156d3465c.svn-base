	...
	<div class="main"> 
        	...
        	<div class="listBox2 thBg">
               ...
               <table  class="table-horizontal" width="100%">
               	   <tr>
                       <td class="bg-gray right" style="width: 100px;"><div class="ipt-box">审批事项编码</div></td>
                       <td colspan="5">
                       	<div class="ipt-box">${codeLicense.exaCode}</div>
                       </td>
                   </tr>
                   <tr>
                       <td class="bg-gray right"><div class="ipt-box">审批事项名称</div></td>
                       <td colspan="5">
                       	<div class="ipt-box">${codeLicense.exaName}</div>
                       </td>
                   </tr>
                   <tr>
                       <td class="bg-gray right"><div class="ipt-box">审批部门</div></td>
                       <td colspan="5">
                       	<div class="ipt-box">${codeLicense.licDept}</div>
                       </td>
                   </tr>
                   <tr>
                       <td class="bg-gray right"><div class="ipt-box">审批部门级别</div></td>
                       <td colspan="5">
...
<script src="<c:url value="/js/syn/system/codeLicense/codelicense_view_main.js"/>"></script>
<script>
    window._CONFIG = {
