                            ...
                            <div class="col-4">
                                ...
                                <div class="col-9">
                                    <div class="ipt-box col-5">
                                        <input name="limitDateStart" type="text" class="ipt-txt laydate-icon"
                                               onclick="laydate();" readonly />
                                    </div>
                                    <span class="item-txt">至</span>
                                    <div class="ipt-box col-5">
                                        <input name="limitDateEnd" type="text" class="ipt-txt laydate-icon"
                                               onclick="laydate();" readonly />
                                    </div>
                                </div>
                            </div>
...
<div class="clearfix mb5 mt5">
    <p class="fl"><input id="limitmanage" type="button" class="btn btn-sm mr5" value="限制管理"/></p>
</div>
...
<script src="/js/reg/server/registmanage/qualifiedmanage/qualifiedlimit.js"></script>
</body>
</html>