        ...
        <div class="content">
            ...
            <div class="title">
                <h3>
                  ...
                  -->
                    <c:if test="${yrPbWebsiteInfo.webType=='2'}">网店(或微店)</c:if>
                    <c:if test="${yrPbWebsiteInfo.webType=='1'}">
                        ${yrPbWebsiteInfo.webSmallType=='1'?'交易网站':'信息网站'}
                    </c:if>
                </h3>
            </div>
            <table class="table-public table-contact" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="odd focus-state">
                        ...
                        <div class="ipt-box js-ipt-box">
                            <input type="text" name="webSitName" value="${yrPbWebsiteInfo.webSitName}" class="ipt-txt ipt-txt-lg " readonly>
                        </div>
                    </td>
                    ...
                    <td class="odd focus-state">
                        ...
                        <div class="ipt-box js-ipt-box">
                            <input type="text" name="webSite" value="${yrPbWebsiteInfo.webSite}" class="ipt-txt ipt-txt-lg" readonly>
                ...
                <tr>
                    <td class="odd focus-state" colspan="2">
                        ...
                        <div class="ipt-box js-ipt-box">
                            <input type="text" name="icpBackNO" value="${yrPbWebsiteInfo.icpBackNO}" class="ipt-txt w-730" placeholder="" readonly>
                ...
                <tr>
                    <td class="odd focus-state">
                        ...
                        <div class="ipt-box js-ipt-box">
                            <input type="text" name="weChatPublicNO" value="${yrPbWebsiteInfo.weChatPublicNO}" class="ipt-txt ipt-txt-lg " placeholder="如有多个请以；隔开" readonly>
                    ...
                    <td class="odd focus-state">
                        ...
                        <div class="ipt-box js-ipt-box">
                            <input type="text" name="appNames" value="${yrPbWebsiteInfo.appNames}" class="ipt-txt ipt-txt-lg " placeholder="如有多个请以；隔开" readonly>
                        </div>
                    </td>
                </tr>
                </tbody>
                ...
                <!-- 交易网站 start -->
            <div style="display: ${yrPbWebsiteInfo.webSmallType=='1'?'block':'none'}">
                    <table class="table-public table-contact" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                        <tr>
                            <td class="odd focus-state" colspan="2">
                                ...
                                <div class="ipt-box js-ipt-box radio-box">
                                    &nbsp;
                                    ${yrPbWebsiteInfo.webPlatFormType}
                                </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <!--网店 start-->
                    <div style="display: ${yrPbWebsiteInfo.webType=='2'?'block':'none'}">
                        <table class="table-public table-contact" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr>
                                <td class="odd focus-state" colspan="2">
                                    ...
                                    <div class="ipt-box js-ipt-box radio-box">
                                        &nbsp;
                                        ${yrPbWebsiteInfo.belongPlatFormName}
                                    </div>
                                    <div class="ipt-box js-ipt-box" id="js-select-other" style="display: none">
                                        <input type="text" id="js-other" value="${yrPbWebsiteInfo.belongPlatFormName}"
                            ...
                            <tr>
                                <td class="odd focus-state" colspan="2">
                                    ...
                                    <div class="ipt-box js-ipt-box">
                                        <input type="text" name="sendAddress" value="${yrPbWebsiteInfo.sendAddress}"
                            ...
                            <tr>
                                <td class="odd focus-state" colspan="2">
                                    ...
                                    <div class="ipt-box js-ipt-box">
                                        <input type="text" name="backAddress" value="${yrPbWebsiteInfo.backAddress}"
                                               class="ipt-txt w-730" placeholder="" readonly>
                                    </div>
                                </td>
                            </tr>
