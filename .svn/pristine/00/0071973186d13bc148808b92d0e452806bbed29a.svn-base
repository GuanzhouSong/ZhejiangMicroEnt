        ...
        <div class="form-list">
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="regState" class="clx regState1">
                                <c:forEach var="regState" items="${regStateCunxuEnumMap}">
                                	<option value='${regState.value.code}'>${regState.value.name}</option>
                            	</c:forEach>
                            </select>
                            <select name="regState" class="clx regState2" style="display: none" disabled="disabled">
...
<!--                     </div> -->
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" readonly="readonly" class="ipt-txt clx" id="localAdmName" value="" placeholder="请选择企业管理部门"/>
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="businessStatus" id="businessStatus" class="clx">
            ...
            <div class="form-item clearfix">
                <div class="col-4 apply_in">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" name="auditName" value="" >
                        </div>
                    </div>
                ...
                <div class="col-4 apply_in">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon clx" readonly="readonly" onclick="laydate()" name="addSecTermBegin" value="">
                        </div>
                        <span class="item-line col-05">-</span>
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon clx" readonly="readonly" onclick="laydate()" name="addSecTermEnd" value="">
                        </div>
                    </div>
                </div>
                <div class="col-4 apply_in">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" name="applyMan" value="" >
                        </div>
                    </div>
                </div>
                <!-- <div class="col-4 apply_in">
            ...
            <div class="form-item clearfix apply_in">
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" name="addSecOrg">
                        </div>
                    </div>
                </div>
                <div class="col-4">
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="addSecCause" class="clx">
            ...
            <div class="form-item clearfix apply_in">
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" name="addSecNo" value="" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-item clearfix apply_in" >
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt clx" name="firstName" value="" >
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="applyExp" class="clx">
                                <option value="">全部</option>
