...
<div class="tabbale" data-component="tab">
        ...
        <div class="form-list">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt" name="licDept" value="" placeholder="请输入审批机关">
                ...
                <div class="col-4">
                    <label class="item-name col-5">对应审批部门：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="hidden" id="deptCode" name="deptCode" value=""  />
                            <input type="text" class="ipt-txt" id="deptNameText" value="" placeholder="请选择对应审批部门"/>
            ...
            <div class="form-item clearfix mb10">
             ...
             <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5">实际审批部门：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="hidden" id="adCode" name="adCode" value="" >
                            <input type="text" class="ipt-txt" id="orgNameText" value="" placeholder="请选择实际审批部门">
    ...
    <div class="clearfix mb5">
        ...
        <!-- <p class="fl" ><input type="button" class="btn btn-sm mr5" value="生成审批对照数据"
 ...
 <script src="<c:url value="/js/syn/system/licdept/licdept_list_main.js"/>"></script>
 </body>
</html>