        ...
        <div class="popup-hd">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="popup-table">
                <tr>
                    ...
                    <td><input type="text" class="ipt-txt" name="licNO" required></td>
                </tr>
                <tr>
                    <td align="right">许可文件名称</td>
                    <td><input type="text" name="licName" required></td>
                </tr>
                <tr>
                    <td align="right">有效期自</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="licAnth" required></td>
                </tr>
                <tr>
                    <td align="right">登记状态</td>
                    <td><input type="text" name="regState" required></td>
                </tr>
            </table>
        </div>
...
<script src="/js/depsyn/license/license_add_main.js"></script>
</body>
</html>