...
<div class="tabbale" data-component="tab">
    <form id="taskForm" class="form-box">
        <input type="hidden" value="1" name="isNeedDelegate"/>
...
<div class="mb5 mt5">
    <p>
        <input  type="button" class="btn btn-sm mr5 enadd js-add" id="setDelegate" value="设置委托">
        <input  type="button" class="btn btn-sm mr5 enadd js-add" id="cancleDelegate" value="取消委托">
    </p>
</div>
...
<script src="/js/business/entdbauth/list4delegate.js"></script>
</div>
</body>
</html>
