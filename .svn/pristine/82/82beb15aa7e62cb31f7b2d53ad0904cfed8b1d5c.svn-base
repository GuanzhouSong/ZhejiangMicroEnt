    ...
    <div class="tab-content mb20">
        <div class="tab-panel tab-panel-show">
            <div class="">
			    ...
			    <p class="light">
			            提示：1.推送户数是指:针对某一备案部门自动推送、手动推送、退回的市场主体多少家。2.推送条数是指:针对某一备案部门名下自动推送、手动推送、退回的总条数（推送条数=备案部门处理条数+未接收条数）。3. 备案接收户数是指：备案部门接收的市场主体多少家。4.备案接收条数是指：备案部门已经接收的总条数。
			    5.未接收条数是指:推送到备案部门名下待接收的总条数。6.备案部门处理条数指:备案部门操作处理的总条数（备案部门处理条数=接收条数+回退条数）。7.退回条数是指:备案部门执行退回操作的总条数。
			    8.完成率=(备案部门处理条数/推送条数)*100。
			    <!-- 8.认领率是指：已经认领的条数在推送备案总条数中所占的百分比(认领率=已经认领总条数/推送的备案部门总条数(不包含推送失败、回退、终止))。9.接收率是指:已经接收的条数在推送同级属地总条数中所占的百分比(接收率=已经接收总条数/推送的同级属地部门总条数(不包含推送失败、回退、终止)) -->
			    </p>
			    </div>
			    <table id="user-table" border="0" cellspacing="0" cellpadding="0" class="table-row mt30 nowrap" width="100%">
                        ...
                        <tr>
				            ...
				            <th style="display: none;">备案总条数</th>
				             -->
                        </tr>
                        </thead>
                        <tfoot>
...
<script src="/js/syn/system/pubdzdtinfo/pubdtinfocount_list_main.js"></script>
 </body>
</html>