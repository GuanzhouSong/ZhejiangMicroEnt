...
/**
 * 描述:    cs_pub_dz_dtinfo 对应的Service接口.<br>
 *
 * @author framework generator
 * @date 2016年10月18日
 */
public interface IPubDzDtInfoService extends BaseService {
	/**
	 * 
	 ...
	 * @throws
	 */
	public List<PubDzDtInfoDto> queryPubdtinfoFailReBackListJSON(PageRequest request)throws Exception;
	 ...
	 * @throws
	 */
	public List<PubDzDtInfoDto> selectTransferPubdtinfoList(String checkDep,String exaCode,String areaCode)throws Exception;
	 ...
	 * @throws
	 */
	public List<PubDzDtInfoDto> queryPubdtinfoCancelListJSON(PageRequest request)throws Exception; 
	 ...
	 * @throws
	 */
	public List<PubDzDtInfoDto> selectPubDtInfoCount(PageRequest request)throws Exception;
	 ...
	 * @throws
	 */
	public int insertBatchPubDtinfo(List<PubDzDtInfo> pubDtinfoList)throws Exception; 
