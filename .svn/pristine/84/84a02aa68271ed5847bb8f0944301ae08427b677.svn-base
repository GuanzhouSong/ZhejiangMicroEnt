...
<input type="hidden"  id="licDepType"  value="${codeLicense.licDeptType}" >
    ...
    <!-- 备案信息 -->
	<jsp:include page="pubdtinfobeian_edit.jsp"></jsp:include> 
    <!-- 回退 -->
    <c:if test="${pubDtInfo.reassignType==2}">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0" class="table-horizontal mb5">
	        ...
	        <tr>
	            ...
	            <td class="bg-gray right light" width="10%">备案机关</td>
	            <td><span class="light">${pubDtInfo.reassignDeptName}</span></td>
	        </tr>
	         <tr>
	            <td class="bg-gray right light">备案事项</td>
	            <td>
    ...
    <div class="light-info left">
        <span class="light">提示：请选择指定备案机关。</span>
    </div>
    <table border="0" cellspacing="0" cellpadding="0" class="table-horizontal mb5">
        <tbody>
        <tr>
            <td class="bg-gray right light" width="10%">* 备案事项</td>
            <td width="40%">
                <div class="ipt-box col-12">
        ...
        <tr>
            <td class="bg-gray right light">* 指定备案机关</td>
            <td>
                <div class="ipt-box col-12">
    ...
    <div class="light-info left">
        <span class="light">提示：如果确定不涉及该项备案，请选择“是否终止推送项”为：是。终止后的信息不再参与推送，请谨慎操作。</span>
    </div>
    <table border="0" cellspacing="0" cellpadding="0" class="table-horizontal mt30">
        <tbody>
        <tr>
            <td class="left light" width="50%" colspan="2">
                                      该企业不涉及该项备案，是否终止推送:<input type="radio" name="pubdtinfostop" value="1">是  <input type="radio" name="pubdtinfostop" value="0" checked="checked">否
            </td>
            <!-- <td width="40%">
            ...
            <td>
                <div class="ipt-box col-7">
                    <select id="pubdtinforemark" >
                        ...
                        <option value="不涉及该项备案，终止推送">不涉及该项备案，终止推送</option>  
                    </select>
                </div>
            </td>
        </tr>
 ...
 <script src="<c:url value="/js/syn/system/pubdzdtinfo/pubdtinfohandpush_edit_main.js"/>"></script>
 <script>
    window._CONFIG = {
