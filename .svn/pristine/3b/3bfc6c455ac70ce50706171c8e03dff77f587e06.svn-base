            ...
            columnDefs: [
            	{
 					...
 					render:function(data,type,row,meta){
 						...
 						}else if(row.checkState=='1' && row.disposeState == '1'){
 							return "<a href='javascript:void(0)' class='js_supply'>续录</a>&nbsp;&nbsp;<a href='javascript:void(0)' class='js_detail'>详情</a>";
 						}else{
            	...
            	http.httpRequest({ 
                    ...
                    success: function (data) {
                    	if(data.data !=null){
                        	...
                        	$("#dlrgs").text(dataobj.dlrgs==null?'0':dataobj.dlrgs);
                    		...
                    		$("#dlrgs,#ylrgs,#wwjgs,#ywjgs").text("0");
                    	}
                    }
                });
            }
