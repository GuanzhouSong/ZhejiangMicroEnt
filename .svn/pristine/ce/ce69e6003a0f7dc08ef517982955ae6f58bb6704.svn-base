    ...
    <div class="form-box mb5">
        <div class="form-list">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    <label class="item-name col-3"><span class="ml-20">备案事项：</span></label>
                    <div class="col-9">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5">备案接收：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select id="receiveState" name="receiveState">
                                <option value="">全部</option>
...
<div class="tip-info left">
    ...
    推送备案部门<label id="sendDeptCount" class="light-blue">0</label>个，
...
<script src="/js/syn/system/pubdzdtinfo/pubdtinfosearch_list.js"></script>
</body>
</html>
