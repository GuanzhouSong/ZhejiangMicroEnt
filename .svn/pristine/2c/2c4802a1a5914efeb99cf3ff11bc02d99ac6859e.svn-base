    ...
    <div class="main">
        ...
        <div class="pdlr5">
            <div class="tab">
                ...
                <li><a href="/depsyn/spotview?menu=wtsjcl" class="cur">抽查检查结果</a></li>
            ...
            <div class="panel-bd">
              <form id="hxForm">
                ...
                <input type="button" value="删除" class="ipt-btn  fr mr20 mb3">
                <table cellpadding="0" cellspacing="0" class="table-common">
                    ...
                    <tr>
                        ...
                        <th width="46">检查实施机关</th>
                        <th width="30">提供方式</th>
                        <th width="90">抽查检查类型</th>
                        <th width="72">抽查检查日期</th>
                        <th width="34">抽查检查结果</th>
                        <th width="74">错误代码</th>
                        <th width="74">提交时间</th>
                        <th width="74">反馈时间</th>
                        <th>操作</th>
...
<script src="/js/depsyn/spotmanage.js"></script>
</body>
</html>