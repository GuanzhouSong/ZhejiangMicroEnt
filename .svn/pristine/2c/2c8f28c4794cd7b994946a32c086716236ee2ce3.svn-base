 ...
 */
@Controller
@RequestMapping(value = {"/reg/server/syspermision","/syn/server/syspermision"})
public class SysPermisionController extends BaseController {
    ...
    public ModelAndView role_permission_show(String roleId) throws Exception {
        ModelAndView mav = new ModelAndView( "sysuser/role_permission_show");
    ...
    public ModelAndView show(String id, String sid) throws Exception {
        ModelAndView view = new ModelAndView("syspermision/edit");
