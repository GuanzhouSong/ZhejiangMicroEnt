    ...
    <div class="mt10">
        <div class="tabbale" data-component="tab">
            <div class="tab-content">
              	...
              	<input type="hidden" name="checkObjType" value="${checkObjType}">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
                            <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td width="35%"><input type="text" name="checkObj" readonly="readonly" value="${entName }"></td>
	                                <td width="15%" class="bg-gray right">统一信用代码/注册号</td>
	                                <td width="35%">
		                                <input type="text" name="cidRegNO"
	                            ...
	                            <tr>
	                                ...
	                                <td><input id="lerep" name="lerep" <c:if test="${flag=='2' }">readonly="readonly"</c:if> type="text" size="15" placeholder="姓名"> <input id="tel" name="tel" <c:if test="${flag=='2' }">readonly="readonly"</c:if> type="text" size="15" placeholder="手机号"></td>
	                            </tr>
	                            <tr>
	                                <td class="bg-gray right"><span class='light'>*</span>联系人</td>
	                                <td><input id="liaName" name="liaName" <c:if test="${flag=='2' }">readonly="readonly"</c:if> type="text" size="15" placeholder="姓名"> <input id="liaTel" name="liaTel" <c:if test="${flag=='2' }">readonly="readonly"</c:if> type="text" size="15" placeholder="手机号"></td>
	                            </tr>
	                            <tr>
	                                <td class="bg-gray right" width="15%"><span class='light'></span>任务来源</td>
	                                <td width="85%" colspan="3">
	                                	<input name="taskSource" type="radio" value="1">交办转办
	                                	<c:if test="${flag=='2' }"><input name="taskSource" type="radio" value="2">投诉举报</c:if>
	                            ...
	                            <c:if test="${flag=='2' }">
	                            <tr>
	                                <td width="15%" class="bg-gray right">投诉（举报）人</td>
	                                <td width="35%"><input name="complainter" type="text" readonly="readonly"></td>
	                                <td width="15%" class="bg-gray right">联系电话</td>
	                                <td width="35%"><input name="complainterTel" type="text" readonly="readonly"></td>
	                            </tr>
	                            <tr>
	                                <td width="15%" class="bg-gray right">投诉（举报）方式</td>
	                                <td width="35%">
	                                	<input name="complaintType" value="1" type="radio">电话
	                                	<input name="complaintType" value="2" type="radio">短信
	                                	<input name="complaintType" value="3" type="radio">来人
	                                	<input name="complaintType" value="4" type="radio">来函
	                                	<input name="complaintType" value="5" type="radio">传真
	                                	<input name="complaintType" value="6" type="radio">互联网络
	                                </td>
	                                <td width="15%" class="bg-gray right">投诉（举报）日期</td>
	                                <td width="35%"><input name="complaintDate" type="text" readonly="readonly"></td>
	                            </tr>
	                            <tr>
	                                <td class="bg-gray right" width="15%"><span class='light'></span>投诉举报内容</td>
	                                <td width="85%" colspan="3">
	                                	<textarea name="complaintContent" rows="3" cols="100" readonly="readonly"></textarea>
	                                </td>
	                            </tr>
	                            </c:if>
	                         </tbody>
	                       ...
	                       <table id="table2" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
	                            ...
	                            <tr>
	                                ...
	                                <td><input id="checkName1" name="checkName1" type="text"></td>
	                                <td><input id="problem1" name="problem1" type="text"></td>
	                                <td><input id="dispose1" name="dispose1" type="text"></td>
	                            </tr>
	                          </tbody>
	                       </table>
