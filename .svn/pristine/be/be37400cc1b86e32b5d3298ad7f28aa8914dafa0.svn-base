        ...
        <div class="form-list">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="entTypeCatg" style="cursor: pointer;">
                ...
                <div class="col-4">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-5">
                            <input type="text" class="ipt-txt" readonly="readonly" name="startDate" onclick="laydate()">
                        </div>
...
<script src="/js/syn/system/drcheck/pubscinforesultsearch_list.js"></script>
</body>
</html>