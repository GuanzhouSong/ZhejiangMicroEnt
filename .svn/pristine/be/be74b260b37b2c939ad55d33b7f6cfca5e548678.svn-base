...
<script src="/js/common/select/syn_dept_tree_select_city.js"></script>
<script type="text/javascript">
    //var deptDutyCodes='${dutyDeptCodes==null? sessionScope.session_sys_user.dutyDeptCodes:dutyDeptCodes}'
    window._CONFIG = {
        treeUrl: '<c:url value="/common/system/sysdepart/deptTreeCtity"/>'+'?isFilterBySysUser='+'${isFilterBySysUser}'+'&isNoCheck='+'${isNoCheck}'+'&isUserMange='+'${isUserMange}',
        treeType:'${treeType}'
    }
</script>
</body>
