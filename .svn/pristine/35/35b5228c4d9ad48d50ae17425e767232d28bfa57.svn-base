$(function () {
    ...
    function c() {
        ...
        if(k && top.$('.J_menuTab').length > 6 ){
            try {
                var iframe = top.$(".J_mainContent").find('iframe.J_iframe:last')[0];
                if (iframe) {
            ...
            top.$(".J_menuTabs .page-tabs-content .J_menuTab:last").remove();
        ...
        if (k) {
            ...
            top.$(".J_menuTab").find('.js-refresh').removeClass('active');
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
            top.$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").find('iframe.J_iframe:first').after(n);
            top.$(".J_menuTabs .page-tabs-content .J_menuTab:first").after(p);
            g($(".J_menuTab.active"))
        }
        return false
    }
