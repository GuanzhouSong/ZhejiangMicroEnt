require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initDataTable() {
        table = dataTable.load({
            ...
            ajax: {
            	type : "POST",
                url:'/reg/server/yr/individquestionnaire/list.json',
                data:function(d){
             ...
             columnDefs : [
							{
			                    ...
			                    render: function (data, type, row, meta) {
			                    	if (row.auditState == '2') {
			                    	    return "<a class='commit edit'>修正</a>";
			                    	}else{
        ...
        util.bindEvents([{
            ...
            handler: function () {
                ...
                layer.dialog({
                    title: '个转企调查表修正',
                    area: ['90%', '90%'],
                    content: '/reg/server/yr/individquestionnaire/view?pripid='+data.priPID+'&year='+data.year,
