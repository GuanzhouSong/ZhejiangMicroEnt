...
<body>
<input id="dutyDeptCodes" type="hidden" value="${dutyDeptCodes }">
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="ipt-box pd0">
                      ...
                      <input type="text" class="ipt-txt" name="slicenNOName" id="localAdmName" value="${pubScagent.slicenNOName}" readonly/>
