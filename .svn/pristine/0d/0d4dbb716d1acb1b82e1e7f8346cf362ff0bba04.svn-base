    ...
    <div class="main">
        <div class="actual-wrap clearfix">
            ...
            <div class="map-box map-jx fl">
                ...
                <div class="city city-0"><i></i>嘉兴市本级<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 1}">
                <div class="city city-1">南湖区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 2}">
                <div class="city city-2">嘉善县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 3}">
                <div class="city city-3">开发区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 4}">
                <div class="city city-4">港区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 5}">
                <div class="city city-5">平湖市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 6}">
                <div class="city city-6">海盐县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 7}">
                <div class="city city-7">海宁市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 8}">
                <div class="city city-8">桐乡市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 9}">
                <div class="city city-9">秀洲区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                </c:forEach>
            </div>
