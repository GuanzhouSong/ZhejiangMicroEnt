...
<h5 class="com-info-title left pdl10">列入严违信息<a href="javascript:void(0);" class="fr mr10">收起<i
        class="tran-icons"></i></a><a class="fr mr10">异常类列入严违历史记录</a></h5>
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    <tbody>
    <tr>
...
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    <tbody>
    <tr>
        <td class="bg-gray right" width="12%">列入严违期限</td>
        <td></td>
        <td class="bg-gray right" width="10%">经办人</td>
        <td></td>
        <td class="bg-gray right" width="11%">申请日期</td>
        <td></td>
    </tr>
    </tbody>
</table>
