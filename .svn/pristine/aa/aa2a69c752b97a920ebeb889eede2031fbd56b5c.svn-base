...
<form id="psw_edit">
    <div class="pd20 clearfix">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mt10">
            <tr>
                <td class="bg-gray right" width="15%"><span class="light"> </span>登录名：</td>
                <td colspan="3">
			...
			<tr>
				<td class="bg-gray right" width="15%"><span class="light"> *</span>原密码：</td>
				<td colspan="3">
					<div class="ipt-box pd0">
			...
			<tr>
				<td class="bg-gray right" width="15%"><span class="light"> *</span>新密码：</td>
				<td colspan="3">
					<div class="ipt-box pd0">
			...
			<tr>
				<td class="bg-gray right" width="15%"><span class="light"> *</span>再次输入新密码：</td>
				<td colspan="3">
					<div class="ipt-box pd0">
        ...
        <p class="center mt10"><input type="button" id="save" class="btn mr20" value="提 交"/><input type="button" class="btn" value="取 消" id="cancel"/></p>
    </div>
</form>
	...
	<script src="/js/business/sysuser/psw_edit.js"></script>
</body>
</html>