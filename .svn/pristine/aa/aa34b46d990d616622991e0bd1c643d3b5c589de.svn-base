                ...
                <div class="form-list border-bottom pdr10">
                    <div class="form-item clearfix">
                        <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="realName" class="ipt-txt" value="${sysUser.realName}" >
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="form-item clearfix">
                        <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="telPhone" class="ipt-txt" value="${sysUser.telPhone}" />
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="form-item clearfix">
                        <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="phone" class="ipt-txt" value="${sysUser.phone}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            ...
                            <div class="col-9">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="post" class="ipt-txt" value="${sysUser.post}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-item clearfix">
                        <div class="col-12">
                            ...
                            <div class="col-3">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="phoneExt" class="ipt-txt" value="${sysUser.phoneExt}"/>
                                </div>
                            </div>
                    ...
                    <div class="form-item clearfix">
                            ...
                            <div class="col-6">
                                ...
                                <div class="col-9">
                                    <div class="ipt-box">
                                        <input type="text" readonly="readonly" name="email" class="ipt-txt" value="${sysUser.email}" />
                                    </div>
                                </div>
                            </div>
                    </div>
                    <div class="form-item clearfix">
                        <div class="col-12">
                            ...
                            <div class="col-10">
                                <div class="ipt-box">
                                    <input type="text" readonly="readonly" name="desc" class="ipt-txt" value="${sysUser.desc}" />
                                </div>
                            </div>
                        </div>
                    </div>
