                ...
                <div class="tab-panel tab-panel-show">
                    <div class="print-nocard">
                        ...
                        <form id="content_form">
                            <input type="hidden" id="copyFormNo" name="copyFormNo" value="${copySendDto.copyFormNo}"/>
                            ...
                            <div class="bg-gray3">
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt30">
                                    ...
                                    <tr>
                                        ...
                                        <td width="52%">
                                            <div class="ipt-box">
                                                <input id="acceptDepartCodes" class="ipt-txt" type="hidden"
                                                       name="acceptDeptCodes" value="${copySendDto.acceptDeptCodes}"/>
                                                <div class="col-10">
                                                    <input id="acceptDepartNames" class="ipt-txt col-10" type="text"
                                        ...
                                        <td>
                                            <div class="ipt-box">
                                                ...
                                                <input id="copyType" class="ipt-txt" type="text"
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${copySendDto.copyType == 'qywfaj'}">
                                            <td>
                                                <div class="ipt-box">
                                                	<div class="col-10">
                                                    <input id="illegalItem" class="ipt-txt col-10" type="text"
                                                           style="border: 0;" name="illegalItem"
                                                           value="${copySendDto.illegalItem}" readonly/>
                                                </div>
                                                <input id="chose_item" type="button"
                                        ...
                                        <td>
                                            <div class="radio-box">
                                                <p><label><input type="radio" name="copyInfoFrom" value="jcfx" ${copySendDto.copyInfoFrom=='jcfx'?'checked':''}>检查发现</label>
                                                <label><input type="radio" name="copyInfoFrom" value="qzjb" ${copySendDto.copyInfoFrom=='qzjb'?'checked':''}>群众举报</label>
                                                </p>
                                                <p><label><input type="radio" name="copyInfoFrom" value="sjjb" ${copySendDto.copyInfoFrom=='sjjb'?'checked':''}>上级交办</label>
                                                <label><input type="radio" name="copyInfoFrom" value="qt" ${copySendDto.copyInfoFrom=='qt'?'checked':''}>其他</label>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="tb-form-hd">
                                            <div class="center">
                                                <input id="add_detail" type="button"
                                                       style="position:static;" class="btn btn-xs"
                                                       value="添加涉嫌违法当事人">
                                            </div>
                                        </td>
                                                ...
                                                <c:forEach var="copySendIllegal" varStatus="status"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class='last-col'><a href='javascript:void(0)'
                                                                                delVal="${copySendIllegal.clientName}">删除</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="pd3">
                                            <div><textarea id="illegalCase" name="illegalCase" id="illegalCase" cols=" "
                                ...
                                <table border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        ...
                                        <td width="31.5%">
                                            <div class="radio-box">
                                                <label><input class="checkResult" type="radio" name="checkResult" value="0" checked>同意抄送</label>
                                                <label><input class="checkResult" type="radio" name="checkResult" value="1">不抄送</label>
                                                <label><input class="checkResult" type="radio" name="checkResult" value="2">退回修改</label>
                                            </div>
                                        </td>
                                        <td class="tb-form-hd" width="8.4%">审核人</td>
                                        <td>
                                            <div class="ipt-box">
                                                <input id="checkPerson" name="checkPerson" type="text" value="${sysUser.realName}"
                                                       class="ipt-txt" readonly/>
                                            </div>
                                        </td>
                                        <td class="tb-form-hd" width="10%">审核日期</td>
                                        <td>
                                            <div class="ipt-box">
                                                <input id="checkDate" type="text" class="ipt-txt" value="${date}"></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="pd3">
                                            <div>
                                                <textarea id="checkOpinion" cols=" " rows="5" name="checkOpinion" >同意抄送</textarea>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <p class="center mt20">
                                ...
                                <input id="save" type="button" class="btn mr20" value="保存审核意见">
                                <input id="cancel" type="button" class="btn mr20" value="取消"></p>
                        </form>
                    </div>
                </div>
            </div>
...
<script src="/js/syn/system/copysend/cgcs_sh.js"></script>
</body>
</html>