...
<body class="pd10">
 ...
 <div class="light-info mb5 mt5">
    <span class="light">提示：后续处置措施发生完结情况请及时续录。 专项整治检查结果信息不对外公示。</span>
 </div>
<div class="tip-info right">
	查询结果：
	待录入<label id="dlrgs" class="light-blue">0</label>条，
	已录入<label id="ylrgs" class="light-blue">0</label>条，
	未完结<label id="wwjgs" class="light-blue">0</label>条，
...
<script src="/js/reg/server/specialrec/specialrec_input_list.js"></script>
</body>
</html>