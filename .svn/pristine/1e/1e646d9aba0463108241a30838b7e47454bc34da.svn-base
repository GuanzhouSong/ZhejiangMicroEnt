                            ...
                            <div class="bg-gray3">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        ...
                                        <td width="31.5%">
                                            <div class="radio-box">
                                                <label><input class="checkResult" type="radio" name="checkResult" value="0" checked>同意</label>
                                                <label><input class="checkResult" type="radio" name="checkResult" value="1">不同意</label>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="pd3">
                                            <div>
                                                <textarea id="checkOpinion" cols=" " rows="5" name="checkOpinion" >同意</textarea>
                                            </div>
                                        </td>
                                    </tr>
...
<script src="/js/syn/system/sendaffairs/cgcs_sh.js"></script>
</body>
</html>