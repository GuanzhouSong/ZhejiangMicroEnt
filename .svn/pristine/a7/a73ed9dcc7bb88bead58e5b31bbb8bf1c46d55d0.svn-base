require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initDataTable() {
        table = dataTable.load({
            ...
            showIndex: true,
            ajax: {
                url:'/reg/server/opanomaly/pubopanomaly/pubOpanoMalyListJSON.json',
                data:function(d){
...
//    				{data: 'estDate',cut: {length: 20,mark:'...'}},
    ...
    function bind() {
        util.bindEvents([{
            el: '#showpubOpanoMalyList',
            event: 'click',
            handler: function () {
            	window.location.href='/reg/server/opanomaly/pubopanomaly/pubOpanoMalyEntapplyList';
            }
        },{
            el: '.view',
            event: 'click',
