                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mt10 table-form">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="34%">
                                        <div class="radio-box" id="auditStateDiv_other">
                                            <label><input type="radio" value="2"  id="auditStateDiv_other2">通过</label>
                                            <label><input type="radio" value="3"  id="auditStateDiv_other3">不通过 </label>
                                            <label><input type="radio" value="5"  id="auditStateDiv_other5">退回修改 </label>
                                        </div>
                                    </td>
                                    <td class="bg-gray right" width="10%">审核人</td>
                                ...
                                <tr>
                                    <td class="bg-gray right">审核意见</td>
                                    <td class="h76" colspan="5">
                                        <div><textarea id="auditOpin_other" cols=" " rows="5" ></textarea></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
