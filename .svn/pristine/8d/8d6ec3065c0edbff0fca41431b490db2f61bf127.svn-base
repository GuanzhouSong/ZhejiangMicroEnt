 ...
 */
@Controller
@RequestMapping("/quartz/pubDzDtInfoPush")
public class PubDzDtInfoQuartzJobController extends BaseController{
	@Autowired
	private IPubDzDtInfoQuartzJobService pubDtInfoQuartzJobService; 
	...
	public ModelAndView pubdtinfoMaintainPush() throws Exception{
		ModelAndView view  = new ModelAndView("/syn/system/pubdzdtinfo/pubdtinfoMaintain_edit");
		return view;
	}
