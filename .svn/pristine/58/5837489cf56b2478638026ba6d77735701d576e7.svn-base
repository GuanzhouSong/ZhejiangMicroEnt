...
<!--     <button type="button" id="addBtn" class="btn btn-primary mt5">批量认领</button> -->
    <div class="light-info mb5 mt5">
        <span class="light">提示：列表中的党员信息来源系统对企业在登记或年报信息中有党员信息的自动推送。 <i class="light-box-y mr5"></i>表示党员所在的企业登记状态异常。 </span>
    </div>
...
<script src="/js/reg/server/partycreate/party_member_cliam_list.js"></script>
</body>
</html>
