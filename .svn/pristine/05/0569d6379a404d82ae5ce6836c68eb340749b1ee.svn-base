        ...
        util.bindEvents([
            {
                ...
                handler: function () {
                    ...
                    layer.confirm('确定认领吗?', {icon: 2, title: '提示'}, function () {
                        http.httpRequest({
                            url: window._CONFIG.chooseUrl + '/pubdzdtinfo/doreceive',
                            serializable: true,
                            data: formParam,
                            type: 'post',
            ...
            },
            {
                ...
                handler: function () {
                    layer.dialog({
                        title: '',
                        area: ['640px', '400px'],
                        content: window._CONFIG.chooseUrl + '/pubdzdtinfo/reback?priPId=' + window._CONFIG._priPID + '&uid=' + window._CONFIG._uid,
