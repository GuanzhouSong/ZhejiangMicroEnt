...
/**
 * 描述:    cs_lic_dz_dept 对应的Service接口.<br>
 *
 * @author framework generator
 * @date 2016年10月19日
 */
public interface ILicDzDeptService extends BaseService {
	/**
	 * 
	 * 描述   保存
	 * @author 赵祥江
	 ...
	 * @throws
	 */
	public LicDzDept selectLicDeptByExaCodeAndDeptCode(String exaCode,String deptCode,String dutyDeptCode,String isValid)throws Exception;
	 ...
	 * @throws
	 */
	public List<LicDzDept> selectLicDeptByExaCodeAndDeptCodeAndDutyDeptCode(String exaCode,String deptCode,String dutyDeptCode)throws Exception;
	 ...
	 * @throws
	 */
	public List<LicDzDeptDto> queryLicDeptListJSON(PageRequest request)throws Exception;
	 ...
	 * @throws Exception
	 */
	List<LicDzDeptDto> queryLicDeptByAdCode(String adCode)throws Exception;
	 ...
	 * @throws
	 */
	public List<LicDzDept> selectLicDeptByExaCodeAndDutyDeptCodeAndYiedistrict(String exaCode,String dutyDeptCode,String yiedistrict,String isValid)throws Exception;
