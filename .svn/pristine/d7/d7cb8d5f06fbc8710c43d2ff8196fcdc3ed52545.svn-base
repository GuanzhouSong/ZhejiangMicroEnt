    ...
    <div class="main">
        <div class="actual-wrap actual-w clearfix">
            ...
            <div class="map-box map-wenzhou fl">
                ...
                <div class="city city-0"><i></i>温州市本级<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 1}">
                <div class="city city-1">永嘉县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 2}">
                <div class="city city-2">鹿城区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 3}">
                <div class="city city-3">瓯海区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 4}">
                <div class="city city-4">文成县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 5}">
                <div class="city city-5">泰顺县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 6}">
                <div class="city city-6">直属管理分局<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 7}">
                <div class="city city-7">开发区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 8}">
                <div class="city city-8">乐清市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 9}">
                <div class="city city-9">瓯江口<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 10}">
                <div class="city city-10">龙湾区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 11}">
                <div class="city city-11">洞头县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 12}">
                <div class="city city-12">瑞安市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 13}">
                <div class="city city-13">平阳县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 14}">
                <div class="city city-14">苍南县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                </c:forEach>
            </div>
