    ...
    <div class="tabbale" data-component="tab">
        <div class="tab-header">
            <ul class="clearfix type-tab clear">
                ...
                <li id="tab2"><span class="tab-item"><a href="javascript:void(0);" id="menu2" >许可审批信息</a></span></li>
		...
		<div class="tab-content mb20">
         ...
         <div class="tab-panel" id="con_menu_2" >
              <div class="mt10">
                <h4 class="h4-title mt10">许可审批信息</h4>
...
<script src="/js/syn/system/pubdtinfo/pubdtinfoDetail_tab.js"></script>
</html>