    ...
    <div class="main">
        ...
        <div class="drjgtj-box">
            ...
            <div class="upload-box">
                <label for="">请上传文件（仅限Excel文件）</label><input type="text"><input type="button" value="浏览.." class="ipt-btn">
            </div>
            <p class="center mt55">
                <input type="button" value="上传" class="ipt-btn" style="margin-right: 55px"><input type="button" value="取消" class="ipt-btn">
            </p>
        </div>
    </div>
</div>
