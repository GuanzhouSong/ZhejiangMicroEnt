...
<jsp:include page="../common/menu.jsp?module=qygjcx&menu=qygjcx"></jsp:include>
        ...
        <div class="clearfix">
            ...
            <div class="tab-header tab-detail">
                <ul class="clearfix">
                    ...
                    <li class="tab-selected"><a class="tab-item" href="../../depsyn/search/jsinfo?encryPriPID=${entBasicInfo.encryPriPID }&classFlag=1">企业即时信息</a>
                    </li>
    ...
    <tr>
        ...
        <td valign="top" style="padding:0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="inner-table ">
                ...
                <tr>
                    <td style="padding:0px;border-top:0px;" width="28%">{{acConFormCn}}</td>
                    <td style="padding:0px;border-top:0px;" width="22%">{{acConAm}}</td>
                    <td style="padding:0px;border-top:0px;" width="32%">{{transDate conDate}}</td>
                    <td style="padding:0px;border-top:0px;">{{trsPubFlag pubFlag}}</td>
                </tr>
                {{/each}} {{/with}}
                </tbody>
            </table>
        ...
        <td valign="top" style="padding:0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="inner-table">
                ...
                <tr>
                    <td style="padding:0px;border-top:0px;" width="28%">{{conFormCN}}</td>
                    <td style="padding:0px;border-top:0px;" width="22%">{{subConAm}}</td>
                    <td style="padding:0px;border-top:0px;" width="32%">{{transDate conDate}}</td>
                    <td style="padding:0px;border-top:0px;">{{trsPubFlag pubFlag}}</td>
                </tr>
                {{/each}} {{/with}}
    ...
    {{/each}}
        ...
        <td>{{dataFormat publicDate}}</td>
        <td><a id={{pleID}} href="javascript:void(0)">查看</a></td>
        </tr>
        {{/each}}
        </script>
        </div>
...
<script src="/js/depsyn/search/iminfosyn_list.js"></script>
</body>
</html>