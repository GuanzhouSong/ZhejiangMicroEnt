...
<div class="light-info mt10">
    ...
    <div class="party-info-wrap">
		...
		<form id="memberform">	
                ...
                <div class="mb5 form-item clearfix pd50">
                                ...
                                <div class="fr">
                                    ...
                                    <div class="fl pdr5">
                                        <div class="ipt-box">
					                       ...
					                       <c:if test="${viewFlag !='1'}">
						                        <input type="text" id="createTime" name="createTime" style="background-color: #F4F4F4"
	                ...
	                <div class="form-item clearfix pd50">
	                    <div class="btn-box mt10 mb20">
	                      <c:if test="${viewFlag != '3'}">
	                        <input type="button"  id="delete" value="删除" class="btn mr20" style="display: none">
            ...
            <c:if test="${viewFlag != '3'}">            
                <span class="title-header ml10 mr10">党员列表</span> <span class="color-red">提示：选中某条信息进行修改或查看操作。新增党员请点击“添加党员”按钮。</span>
            </c:if>
            <c:if test="${viewFlag == '3'}">        
            ...
            <form id="search-form" class="form-box" novalidate="novalidate">
                <input type="hidden" name="priPID" value="${dto.priPID}"/>
                <input type="hidden" name="quryAll" value="1"/>
                <div class="form-list">
                    <div class="form-item clearfix">
                        ...
                        <div class="col-4">
                           ...
                           <c:if test="${viewFlag != '3'}"> 
                            <input id="addbtn" type="button" value="添加党员" class="btn mr20">
                           </c:if>
                        </div>
                    </div>
...
window._CONFIG = {
    viewFlag:'${viewFlag}', 
    auditState:'${partyMemberInfo.auditState}',
}
</script>
<script src="/js/lib/jquery/jquery-1.12.3.min.js"></script>
<script src="/js/lib/require.js"></script>
<script src="/js/config.js"></script>
<script src="<c:url value="/js/reg/server/partycreate/party_member_add_edit.js"/>"></script>
</body>
</html>
