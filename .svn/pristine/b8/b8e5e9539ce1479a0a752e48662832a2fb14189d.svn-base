        	...
        	<div class="listBox2 thBg">
                    ...
                    <table class="table-horizontal">
                        ...
                        <tr>
	                        ...
	                        <td colspan="6">
		                        <div class="ipt-box">
		                        	<textarea disabled="disabled" class="txt_1" readonly="readonly" maxlength="500">${pubPbopanomalyDto.excpStaResCN }
		                        	</textarea>
	                        	</div>
	                        </td>
                        </tr>
                        ...
                        <div class="radio-box" id="unusualRadio">
                            <label <c:if test="${pubPbOpadetailDto.recoveryType=='2' }"> style="display: none" </c:if> class="font-12">
                            	<input type="radio"
                            	 ...
                            	 class="view-opadetail" name="auditState" id="yes" value="1"/>予以恢复正常
                            </label>
                            <label <c:if test="${pubPbOpadetailDto.recoveryType=='2' }"> style="display: none" </c:if> class="font-12">
                            	<input type="radio"
                            		<c:if test="${pubPbOpadetailDto.auditState=='2' }"> checked </c:if>
                            	 class="view-opadetail" name="auditState" id="no" value="2"/>不予恢复正常
                            </label>
                            <label <c:if test="${pubPbOpadetailDto.recoveryType=='1' }"> style="display: none" </c:if> class="font-12">
                            	<input type="radio"
                            	 ...
                            	 class="view-opadetail" name="auditState" id="yes2" value="3"/>予以更正恢复
                            </label>
                            <label <c:if test="${pubPbOpadetailDto.recoveryType=='1' }"> style="display: none" </c:if> class="font-12">
                            	<input type="radio"
                            		<c:if test="${pubPbOpadetailDto.auditState=='4' }"> checked </c:if>
                            	 class="view-opadetail" name="auditState" id="no2" value="4"/>不予更正恢复
                            </label>
                        </div>
                        <div class="ipt-box">
                            <textarea id="auditOpin" name="auditOpin" maxlength="500"
                                  class="txt_1 view-opadetail"><c:choose><c:when test="${pubPbOpadetailDto.auditState=='2'||pubPbOpadetailDto.auditState=='4' }">${pubPbOpadetailDto.auditOpin}</c:when><c:otherwise>予以恢复正常</c:otherwise></c:choose></textarea>
                        </div>
...
<script src="/js/reg/server/opanomaly/pbopanomaly/pbopadetail_check.js"></script>
</html>
<style type="text/css">
table.gridtable {
