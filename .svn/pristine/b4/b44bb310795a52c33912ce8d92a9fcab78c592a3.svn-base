    ...
    <div class="" style="margin-top: 20px;">
        <form  id="modapplication-form">
        	...
        	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mt10">
	            <tr>
	                <td width="15%" class="bg-gray right">统一社会代码/注册号</td>
	                <td width="17%">
	                    ${(!empty modApplicationDto.unicode)?modApplicationDto.unicode:modApplicationDto.regNo}
	                </td>
	                ...
	                <td width="8%" class="bg-gray right">年报年度</td>
	                <td width="20%">
	                 ${modApplicationDto.year }
	                </td>
	            </tr>
	            <tr>
	                <td class="bg-gray right">年报状态</td>
	                <td>
	            ...
	            <tr>
	                <td class="bg-gray right">修改原因及内容</td>
	                <td colspan="5">
	                ...
	                <td colspan="5">
	                	<div class="col-xs-9">
	                	 <div class="ipt-box pd0">
	                		<input type="text" class="ipt-txt required"   name="modDescription" id="modDescription"/>
	                     </div>
	                	</div>
	                </td>
	            </tr>
        ...
        <input type="hidden" value="${modApplicationDto.priPID }" id="priPID"/>
         <table id="modapplicationhis"border="0" cellspacing="0" cellpadding="0" class="table-row mt20" style="width: 100%;white-space: nowrap;">
	        <thead>
		        <tr>
		            <th>序号</th>
		            <th>申请时间</th>
...
<script src="/js/reg/server/yr/modapplication/edit_main.js"></script>
</body>
</html>