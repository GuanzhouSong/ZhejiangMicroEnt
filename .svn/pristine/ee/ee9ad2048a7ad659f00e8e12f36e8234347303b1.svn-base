            ...
            <table class="table-public table-contact" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="odd">
                        ...
                        <div class="item-txt">
                        <fmt:formatNumber value="${yrPbBaseInfo.vendInc}" pattern="###,###,###,##0.0000"/>万元
                    </td>
                    <td class="odd">
                        <div class="item-name">纳税总额：</div>
                        <div class="item-txt">
                        <fmt:formatNumber value="${yrPbBaseInfo.ratGro}" pattern="###,###,###,##0.0000"/>万元
                        </div>
                    </td>
                </tr>
                </tbody>
...
<script src="/js/reg/server/yr/pbaddrec/pbaddrec_preview.js"></script>
</body>
</html>