...
(function() {
    ...
    function listen(callBack) {
        ...
        if (icinfo.browser.ie) {
            ...
            console.log("icinfo.history.listen>>>", _curHash, location.hash.replace(/^#/, ''));
        }
    }
...
icinfo.seal.server = {
    ...
    //
//    	    objImpl.UploadSignInfoUrl = "http://"+SealSvr+"/tseal/external/localSignedAction.do";
//	    objImpl.RemoteSignUrl = "http://"+SealSvr+"/tseal/external/remoteSignedAction.do";
//	    objImpl.DownloadSignInfoUrl = "http://"+SealSvr+"/tseal/external/getSignedInfoAction.do";
//	    objImpl.DownloadSignCertUrl = "http://"+SealSvr+"/tseal/external/getSignedCertAction.do";
//	    objImpl.DownloadSignImgUrl = "http://"+SealSvr+"/tseal/external/getSignedImgAction.do";
//	    objImpl.RemoteVerifyUrl = "http://"+SealSvr+"/tseal/external/checkSignInfoAction.do";
//	    objImpl.DownloadUserInfoUrl = "http://"+SealSvr+"/tseal/external/getCertuserSealAction.do";
//	    objImpl.DownloadThumbnailUrl = "http://"+SealSvr+"/tseal/external/seal-rest.do?";
...
icinfo.seal.event = {
    ...
    create: function(options) {
        ...
        try {
            ...
            var ref = document.getElementById("sealDiv");
            
            if (ref) {
            	 ref.parentNode.insertBefore(sealElement, ref);
            }
...
icinfo.seal.define = function(namespace, controller, callback) {
    ...
    if (!controllerElement) {
        ...
        ref.parentNode.insertBefore(controllerElement, ref);
    }
