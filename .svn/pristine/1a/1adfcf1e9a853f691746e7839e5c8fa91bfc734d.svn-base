    ...
    <div class="form-list">
        ...
        <div class="form-item clearfix">
            <div class="col-4">
                ...
                <div class="col-6">
                    <div class="ipt-box col-12">
                            <input type="text"  id="localAdm"  class="ipt-txt clx" style="height: 30px;" name="" value="" readonly/>
            ...
            <div class="col-4">
                ...
                <div class="col-8">
                    <div class="ipt-box col-12">
                       <input type="text"  id="regOrg"  class="ipt-txt clx" style="height: 30px;" name="" value="" readonly/>
        ...
        <div class="form-item clearfix">
            <div class="col-4">
                <label class="item-name col-6">企业关注状态：</label>
                <div class="col-6">
                    <div class="ipt-box col-12">
            ...
            <div class="col-4">
                ...
                <div class="col-8">
                    <div class="ipt-box col-5">
                        <input type="text" class="ipt-txt" onclick="laydate();" name="markStartDate" readonly="readonly">
                    </div>
                    <span class="item-txt col-2"><i class="line-icon"></i></span>
                    <div class="ipt-box col-5">
                        <input type="text" class="ipt-txt" onclick="laydate();" name="markEndDate" readonly="readonly">
                    </div>
                </div>
            </div>
            <div class="col-4">
		...
		<input value="${csConcernObj.deptCode}" name="deptCode" type="hidden">
		<input value="1" name="needHis" type="hidden">
        <div class="form-item clearfix">
            <div class="btn-box mt10">
                <input type="button" id="search" value="查 询" class="btn mr20">
                <input type="reset" value="重 置" class="btn mr20">
            </div>
        </div>
    </div>
</div>
...
<div>
    <table id="con_apply_table" border="0" cellspacing="0" cellpadding="0" class="table-row perc-100 nowrap">
        <thead>
         <tr>
            <th >序号</th>
            <th >操作</th>
...
<script src="/js/syn/system/concern/conc/con_apply_list.js"></script>
</body>
</html>