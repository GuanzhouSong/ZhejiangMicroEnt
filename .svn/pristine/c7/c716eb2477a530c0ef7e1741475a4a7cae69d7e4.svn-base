    ...
    <div class="main">
        ...
        <div class="pdlr5">
            <div class="tab">
                ...
                <li><a href="<c:url value='/depsyn/license/index'/>"  class="cur">行政许可信息</a></li>
            ...
            <div class="panel-bd">
                <form id="searchForm">
                    <div class="tips">正在填报：行政许可信息</div>
            ...
            <div id="js-result" class="none">
                ...
                <table cellpadding="0" cellspacing="0" class="table-common">
                    ...
                    <tr>
                        ...
                        <th width="192">许可文件名称</th>
                        <th width="150">有效期自</th>
                        <th width="150">有效期至</th>
                        <th width="186">许可机关</th>
...
<script src="/js/depsyn/license/license_main.js"></script>
</body>
</html>