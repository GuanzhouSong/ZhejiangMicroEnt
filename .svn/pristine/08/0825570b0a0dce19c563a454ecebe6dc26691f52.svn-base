      ...
      <div class="form-list">
             ...
             <div class="form-item clearfix">
                 ...
                 <div class="col-4">
                     ...
                     <div class="col-7">
                         <div class="ipt-box col-575">
                           <input type="text" class="ipt-txt pointer laydate-icon" onclick="laydate()" readonly="readonly" name="setTimeStart" value="" />
                         </div>
                         <span class="item-line col-05">-</span>
                         <div class="ipt-box col-575">
                           <input type="text" class="ipt-txt pointer laydate-icon" onclick="laydate()" readonly="readonly" name="setTimeEnd" value="" />
                         </div>
                     </div>
                 </div>
                 <div class="col-4">
...
<script src="/js/reg/server/yr/questionnaire/list_main.js"></script>
</div>
</body>
</html>
