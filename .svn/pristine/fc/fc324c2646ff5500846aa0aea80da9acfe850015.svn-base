...
<div class="tabbale" data-component="tab">
    <div class="tab-header tab-chaogao">
        <ul class="clearfix">
            <li class="tab-selected"><span class="tab-item _tab" id="one">我增设的关注服务标识</span></li>
            <li><span class="tab-item _tab" id="all">全部关注服务标识</span></li>
        </ul>
    </div>
    <div class="tab-content mb20">
        ...
        <div class="tab-panel">
            <form id="form_one">
                ...
                <input type="hidden" id="markFunc" name="markFunc" value="gz"/>
            </form>
            ...
            <div class="table-out">
                <table id="table-one" border="0" cellspacing="0" cellpadding="0" class="table-row nowrap" >
                    <thead>
                    <tr>
                        <th >序号</th>
                        <th >操作</th>
        ...
        <div class="tab-panel">
                    ...
                    <div class="form-list">
                        ...
                        <div class="form-item clearfix">
                            <div class="btn-box">
                                ...
                                <input type="button" id="clx_all" value="重 置" class="btn">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-out">
                <table id="table-all" border="0" cellspacing="0" cellpadding="0" class="table-row nowrap">
                    <thead>
                    <tr>
                        <th >序号</th>
                        <th >操作</th>
...
<script src="/js/syn/system/concern/mark/mark_list.js"></script>
</body>
</html>