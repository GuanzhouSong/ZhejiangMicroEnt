    ...
    <div class="main">
        ...
        <div class="drjgtj-box">
            ...
            <div class="upload-box">
                <label for="">请上传文件（仅限Excel文件）</label><input type="text" id="js-excel-file" readonly><input
                    type="button" value="浏览.." class="ipt-btn js-ipt-btn">
                <input name="file" type="file" id="js-file-btn" style="display: none">
            </div>
            <p class="center mt55">
                <input id="js-upload" type="button" value="上传" class="ipt-btn" style="margin-right: 55px">
                <input id="js-cancel" type="button" value="取消" class="ipt-btn">
            </p>
        </div>
    </div>
</div>
...
<script src="/js/depsyn/upload/punish_upload.js"></script>
</body>
</html>