require([
    ...
    function int_table_last(){
        var options = {
            ...
            url:'/reg/server/yr/forinvestment_server/list_json_last',             //url 访问路径             必填项
            type:'post',                                                         //请求方式
    ...
    function init_table_tody(){
        var options = {
            ...
            url:'/reg/server/yr/forinvestment_server/list_json_tody',             //url 访问路径               必填项
            type:'post',                                                         //请求方式
    ...
    function _money(year,priPID,msg){
        http.httpRequest({
            url: '/reg/server/yr/forinvestment_server/countMoney',
            serializable: false,
            type: 'post',
