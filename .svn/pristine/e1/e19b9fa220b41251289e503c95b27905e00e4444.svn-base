...
<div class="form-box">
    <div class="form-list">
        ...
        <div class="pd20">
            <table cellspacing="0" cellpadding="0" border="0" width="100%" class="table-horizontal">
                <tr>
                    <td rowspan="3" class="ft14 bg-gray" align="right" width="14%">数据查询条件</td>
                    <td width="15%" align="right" class="table-noborder">操作关系：</td>
                    <td class="no-border-l">
                        <div class="radio-box">
                            <label><input type="radio" name="">和</label>
                            <label><input type="radio" name="">或</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="no-border-l">
                        <div class="radio-box">
                            <label><input type="checkbox" name="">监管项目</label>
                            <label><input type="checkbox" name="">分类标签</label>
                            <label><input type="checkbox" name="">片区/商圈</label>
                            <label><input type="checkbox" name="">个转企日期</label>
                            <label><input type="checkbox" name="">法定代表人联系电话</label>
                            <label><input type="checkbox" name="">户口联系电话</label>
                            <label><input type="checkbox" name="">经营场所地址</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="no-border-l">
                        <div class="radio-box">
                            <label><input type="checkbox" name="">片区/商圈与管辖单位不匹配</label>
                        </div>
                    </td>
                </tr>
            </table>
...
<div class="clearfix mb5 mt20">
    ...
    <p class="fl"><input type="button" class="btn btn-sm mr5" value="批量建档"><input type="button" class="btn btn-sm" value="导出"></p>
</div>
<div>
