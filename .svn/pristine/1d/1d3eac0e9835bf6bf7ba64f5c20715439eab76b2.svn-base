                        ...
                        <div class="print-nocard">
                            ...
                            <div class="bg-gray3">
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt30">
                                    ...
                                    <tr>
                                        <td class="tb-form-hd">惩戒当事人列表<input type="button" class="btn btn-xs add" value="添加"></td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt10">
                                    <tbody><tr>
                                        ...
                                        <td width="31.5%">
                                            <div class="radio-box">
                                                <label><input type="radio">同意抄送</label>
                                                <label><input type="radio">不抄送</label>
                                                <label><input type="radio">退回修改</label>
                                            </div>
                                        </td>
                                        <td class="tb-form-hd" width="8.4%">审核人</td>
                                        <td></td>
                                        <td class="tb-form-hd" width="8.4%">审核日期</td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="pd3">
                                            <div><textarea name="" cols=" " rows="5"></textarea></div>
                                        </td>
                                    </tr>
