...
<script id="listTemplate" type="text/x-handlebars-template">
    ...
    <div class="option-item">
        <label class="clearfix">
            <div class="right col-1 pdr5"><input type="radio" id="{{id}}" class="" name="selecttype"></div>
            <span class="name col-10 content"><strong>{{text1}}</strong>{{text2}}</span>
        </label>
    </div>
    {{/each}}
</script>
...
<script src="/js/common/select/selectintercept.js"></script>
</body>
</html>