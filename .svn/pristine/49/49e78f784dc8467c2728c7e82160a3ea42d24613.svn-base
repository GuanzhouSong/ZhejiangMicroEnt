...
<div class="mb20">
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            <div class="tip">
                基本信息由政府各部门提供，信息的真实性准确性由政府各部门负责
            </div>
            <h3 class="i-title">
                <i></i>照面信息
            </h3>
            <ul class="encounter-info clearfix">
                <li>
                    <span class="title">注册号/统一社会信用代码：</span>
                    <span>${entBasicInfo.regNO }</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span>${entBasicInfo.entType }</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span>
                   		 <fmt:formatDate value="${entBasicInfo.estDate}" pattern="yyyy-MM-dd"/> 
                    </span>
                </li>
                <li>
                    <span class="title">营业期限自：</span>
                    <span>
                    	<fmt:formatDate value="${entBasicInfo.opFrom}" pattern="yyyy-MM-dd"/> 
                    </span>
                </li>
                <li>
                    <span class="title">营业期限至：</span>
                    <span>
                    	<fmt:formatDate value="${entBasicInfo.opTo}" pattern="yyyy-MM-dd"/> 
                    </span>
                </li>
                <li>
                    <span class="title">登记机关：</span>
                    <span>${entBasicInfo.regOrg }</span>
                </li>
                <li>
                    <span class="title">核准日期：</span>
                    <span>
                    	<fmt:formatDate value="${entBasicInfo.apprDate}" pattern="yyyy-MM-dd"/> 
                    </span>
                </li>
                <li>
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            <h3 class="i-title">
                <i></i>股东及出资信息
                <a href="#" class="more">更看全部>></a>
            </h3>
            <table class="table-common table-gudong">
                <thead>
                <tr>
                    <th class="col-first">
                        股东名称
                ...
                <tr data-id="1">
                    ...
                    <td>
                        <a href="javascript:void(0);" class="js-gudong-view">查看</a>
                    </td>
                </tr>
                <tr data-id="2">
                    <td>
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            ...
            <div class="renyuan-list">
                <div class="item">
                    <span>刘明辉</span>
                    <span class="manager">董事</span>
                </div>
                <div class="item">
                    <span>刘明辉</span>
                    <span class="manager">董事</span>
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            ...
            <table class="table-common table-jigou">
                <thead>
                <tr>
                    <th class="col-first">
                        序号
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            ...
            <table class="table-common table-biegeng">
                <thead>
                <tr>
                    <th class="col-first">
                        变更事项
                ...
                <tr>
                    ...
                    <td>
                        人民币、外币的人身保险（包括各类人寿保险人民币、外币的人身保险（包括各类人寿保险
                    </td>
                    <td>
                        各类人民币、外币的人身保险业务，其中包括
                    </td>
                    <td>
                        2014年5月7日
                    </td>
        ...
        <div class="mod-bd-panel_company">
            ...
            <table class="table-common table-qingsuan">
                ...
                <tr>
                    ...
                    <td class="col-second">张书文</td>
                    <td class="col-three">张书文</td>
                    <td class="col-four">张书文</td>
                    <td class="col-five">张书文</td>
                </tr>
                <tr>
                    <td class="col-second">张书文</td>
                    <td class="col-three">张书文</td>
    ...
    <div class="mod company-about">
        <div class="mod-bd-panel_company">
            ...
            <table class="table-common table-xuke">
                <thead>
                <tr>
                    <th class="col-first">
                        序号
                ...
                <tr data-id="1">
                    ...
                    <td>矿产开采经营</td>
                    <td>有效</td>
                    <td><a href="javascript:void(0);" class="js-license-view">查看</a></td>
                </tr>
                <tr data-id="2">
                    <td>
                        1
...
<script>
    $(document).on('click','.js-gudong-view',function(){
        ...
        layer.open({
            ...
            area: ['580px','700px'],
            title: false,
            content: '/ui/pub/infopublic/infodetail/investmentdetail?id='+id
        })
    });
    $(document).on('click','.js-license-view',function(){
        var id = $(this).closest('tr').attr('data-id');
        layer.open({
            type:2,
            shadeClose: true,
            ...
            area: ['940px','500px'],
            title: false,
            content: '/ui/pub/infopublic/infodetail/licensedetail?id='+id
        })
    });
