...
<body class="pd10">
    <div class="pd10 bg-gray" style="margin-top: 10px;">
       <div class="form-list pdr10">
         ...
         <div id="hideorshow" style="display: none">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-4">录入人员：</label>
                    <div class="col-7">
                        <div class="ipt-box col-11">
 ...
 <div class="light-info mb5 mt5">
    <span class="light">提示：此处仅查询已录入检查结果的日常检查记录信息。 日常检查结果信息不对外公示。</span>
 </div>
<div class="tip-info">
	<div class="right">
...
<script src="/js/syn/system/sccheck/dailyresult/dailyresultquery_list.js"></script>
</body>
</html>