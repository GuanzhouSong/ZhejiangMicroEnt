...
<body class="pd10">
	  <div class="main">
		...
		<form id="pbosaveform"  >
             ...
             <input type="hidden" id="excpStaRes2" value="${pubPbopanomalyDto.excpStaRes }">
             <input type="hidden" name="id" value="${pubPbopanomalyDto.id }">
        	...
        	<div class="listBox2 thBg">
                    ...
                    <table class="table-horizontal">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                            <textarea id="signRea" name="signRea" class="txt_1" maxlength="500">${pubPbopanomalyDto.signRea }</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="bg-gray right"><font color="red">* </font>初审意见(限500字)</td>
                            <td colspan="6">
                            	<textarea id="firstOpin" name="firstOpin" class="txt_1" maxlength="500">${pubPbopanomalyDto.firstOpin }</textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="ipt-box"><input class="laydate-icon ipt-txt" type="text"
                                                  ...
                                                  value="<fmt:formatDate value="${pubPbopanomalyDto.cogDate }" type="date" pattern="yyyy-MM-dd"/>"
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input readonly="readonly" type="text" name="firstName" value="${pubPbopanomalyDto.firstName }"></td>
                            <td class="bg-gray right">初审部门</td>
                            <td><input readonly="readonly" type="text" name="firstDept" value="${pubPbopanomalyDto.firstDept }"> </td>
                        </tr>
                    </table>
                </div> 
            </form>
...
<script src="/js/reg/server/opanomaly/pbopanomaly/pbopanomaly_edit.js"></script>
</html>
<style type="text/css">
table.gridtable {
