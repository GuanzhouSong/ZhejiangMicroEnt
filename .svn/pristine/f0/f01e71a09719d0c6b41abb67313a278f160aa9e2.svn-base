                ...
                <div class="tab-panel tab-panel-show">
                    <div class="">
                        <div class="print-nocard">
                            <h3>
                                <p id="copytitle">部门协同事务提请单（<span id="copyTypeName"></span>）</p>
                                <span>协同事务提请单编号：<span id="copyFormNo"></span></span>
                            </h3>
                            <p class="right print-data">协同事务提请发起日期：<span id="copyDate"></span>
...
<script src="<c:url value="/js/syn/system/sendaffairs/cgcs_print.js"/>"></script> 
