            ...
            <ul class="form-common-list">
                <li>
                    <div class="col-6">
                        ...
                        <div class="item-txt ">
                            <input type="text" readonly name="penDecNo"   placeholder="请输入处罚决定书文号"
                    ...
                    <div class="col-6">
                        ...
                        <div class="item-txt">
                            <input type="text" readonly   class="ipt-txt ipt-txt-small laydate-icon"  name="penDecIssDate"  id="penDecIssDate" class="form-control"   placeholder="请输入处罚决定书签发日期"
                ...
                <li>
                    <div class="col-12">
                        ...
                        <div class="item-txt js-ipt-box">
                                <input readonly type="text" name="judAuth"   class="ipt-txt ipt-lg"  placeholder="请输入处罚机关"
                ...
                <li>
                    <div class="col-12">
                        ...
                        <div class="item-txt">
                            <input type="text" readonly  name="illegActType"   placeholder="请输入违法行为类型"
                ...
                <li>
                    ...
                    <div class="item-txt item-punish-type" >
					 ...
					 <span><label><input  disabled type="checkbox"  ${!empty penType[pr.code]?"checked":"" } name="chose" title="${pr.content }" value="${pr.code }" >${pr.content }</label></span>
                ...
                <li >
                    <div class="col-6" id="penAm" style="display:none;">
                        ...
                        <div class="item-txt ">
                            <input type="text" readonly name="penAm" maxlength="16"  id="penAmT" value="${imCase.penAm }" class="ipt-txt assetItem">
                        </div>
                    </div>
                    <div class="col-6" id="forfAm" style="display:none;">
                        <div class="item-name">没收金额（万元）</div>
                        <div class="item-txt ">
                            <input type="text" readonly name="forfAm" maxlength="16" id="forfAmT" value="${imCase.forfAm}" class="ipt-txt assetItem">
                        </div>
                    </div>
                </li>
                <li>
                    <div class="col-12">
                        ...
                        <div class="item-txt">
                            <input type="text" readonly name="penContent" value="${imCase.penContent }" class="ipt-txt ipt-lg">
                        </div>
                    </div>
                </li>
            </ul>
