...
<object height="20px" id="WebBrowser" classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2"></object>
	...
	<div class="main">
			...
			<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; text-align: center;">
				...
				<span style="mso-spacerun: 'yes'; font-weight: bold; font-size: 22.0000pt; font-family: '宋体';"></span><span style="mso-spacerun: 'yes'; font-weight: bold; font-size: 22.0000pt; font-family: '宋体';">${apply.deptName}</span>
			</p>
			<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; text-align: center;">
				<span style="mso-spacerun: 'yes'; font-weight: bold; font-size: 22.0000pt; font-family: '宋体';">列入严重违法失信企业名单决定书</span>
			...
			<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; line-height: 28.0000pt;">
				<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">（统一社会信用代码/注册号：</span>
				<span style="mso-spacerun: 'yes';  font-size: 16.0000pt; font-family: '仿宋_GB2312';text-decoration:underline;color:red">${apply.uniSCID}/${apply.regNO}</span>
			...
			<p class=p0 style="text-indent: 32.0000pt; margin-bottom: 0pt; margin-top: 0pt; line-height: 28.0000pt;">
				...
				<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">违反工商行政管理法律、行政法规且情节严重</span>
				<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">属于《严重违法失信企业名单管理暂行办法》第五条所规定的应当列入严重违法失信企业名单的情形。</span>
				<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">现根据该办法第五条第一款第（二）至第（八）项（第二款），决定将你单位列入严重违法失信企业名单，</span>
				<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">并通过企业信用信息公示系统向社会公示。列入时间自即日起至____年___月___日止。</span>
			</p>
			<p class=p17 style="text-indent: 32.0000pt; margin-bottom: 0pt; margin-top: 0pt; line-height: 28.0000pt;">
				<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">你单位如对本决定有异议，可以自公示之日起三十日内向我局提出书面申请并提交相关证明材料，要求核实。也可在接到本决定书之日起六十日内向</span>
					<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><span id="span_1" style="text-decoration:underline;color:red;">${apply.deptUpName}</span>或者</span>
					<span style="mso-spacerun: 'yes'; text-decoration: underline; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><span id="span_2" style="text-decoration:underline;color:red;">${apply.deptSameGov}</span></span>
					<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">人民政府申请行政复议；或者六个月内向</span>
					<span style="mso-spacerun: 'yes'; text-decoration: underline; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><span id="span_3" style="text-decoration:underline;color:red;">${apply.deptSameCourt}</span></span>
			...
			<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; text-align: right; line-height: 28.0000pt;" id="entDate">
				<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';color:red;" class="date">
				  <fmt:formatDate value="${apply.addSecDate}" type="date" pattern="yyyy-MM-dd"/>
				</span>
				<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><o:p></o:p></span>
			</p>
		</div> 
