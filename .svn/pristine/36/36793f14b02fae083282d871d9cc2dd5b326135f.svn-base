            ...
            <div class="col-4">
                ...
                <div class="col-8">
                    ...
                    <label class="checkbox-inline font-12">
						 <input type="checkbox" name="catgCode" class="roles required" id="0" value="企业">企业
                            </label>
                          
 					 <label class="checkbox-inline font-12">
  						 <input type="checkbox" name="catgCode" class="roles font-12" id="1" value="个体户">个体户
                            </label>
                            
                      <label class="checkbox-inline font-12">
   							<input type="checkbox" name="catgCode" class="roles font-12" id="2" value="农专社">农专社
                            </label> 
                            </p>  
                    </div>
                </div>
...
<script src="/js/syn/system/drcheck/sctack/leadstack_list.js"></script>
</html>