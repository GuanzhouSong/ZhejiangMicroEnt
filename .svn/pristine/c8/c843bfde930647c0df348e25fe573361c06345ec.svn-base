                    ...
                    <div>
                        <div class="print-nocard">
                            ...
                            <form id="content_form">
                                <input type="hidden" name="copyFormNo" id="copyFormNo"  value="${copySendDto.copyFormNo}"/>
                                ...
                                <div>
                                    <table border="0" cellspacing="0" cellpadding="0" class="table-form mt30">
                                            ...
                                            <td width="52%">
                                                <div class="ipt-box">
                                                    <input id="acceptDepartNames" class="ipt-txt" type="text"
                                                           style="border:0;" value="${copySendDto.acceptDeptNames}"
                                                           readonly/>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="ipt-box">
                                                    <input id="illegalItem" type="text" class="ipt-txt" style="border:0;"
                                            ...
                                            <td>
                                                <div class="ipt-box">
                                                    <input id="copyInfoFrom" type="text" class="ipt-txt"
                                                           value="${copySendDto.copyInfoFromName}" readonly/>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="pd3">
                                                <div><textarea id="illegalCase" cols=" " rows="5"
                                                               readonly>${copySendDto.illegalCase}</textarea></div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pd3">
                                                <div class="ipt-box">
                                                    <input id="feedbackNeed" type="text" class="ipt-txt"
                                                           value="${copySendDto.feedbackNeed=='0'?'是':'否' }" readonly/>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="ipt-box">
                                                    <input id="copyDepartPerson" type="text" class="ipt-txt"
                                                           value="${copySendDto.copyDepartPerson}" readonly>
                                                </div>
                                            </td>
                                            <td class="tb-form-hd">
                                                联系电话（必填）
                                    ...
                                    <table id="fkopt_table" border="0" cellspacing="0" cellpadding="0" class="table-form mt10">
                                        <c:forEach var="copySendFeedback" varStatus="status"
                                                   items="${copySendFeedbackList}">
                                            <c:if test="${copySendFeedback.feedbackTime!=null}">
                                                <tr>
                                                    <td>
                                                        <i class="xbt-icon file-o-icon"></i>${copySendFeedback.acceptDepartName}
                                                        <font class="ml25r55">${copySendFeedback.feedbackPerson}</font>${copySendFeedback.feedback}
                                                        <span class="fr"><fmt:formatDate
                                                                value="${copySendFeedback.feedbackTime}"
                                            ...
                                            <c:if test="${copySendFeedback.feedbackTime==null}">
                                                <tr>
                                                    <td>
                                                        <i class="xbt-icon file-c-icon"></i>${copySendFeedback.acceptDepartName}
                                                        <font class="ml25r55"></font>
                                                        <span class="fr"></span>
                                                    </td>
                                                </tr>
                                            </c:if>
                                ...
                                <p class="center mt20">
                                    ...
                                    <input id="cancel" type="button" class="btn mr20" value="返回"></p>
                            </form>
                        </div>
                    </div>
                </div>
...
<script src="/js/syn/system/sendaffairs/cgcs_cy.js"></script>
</body>
</html>