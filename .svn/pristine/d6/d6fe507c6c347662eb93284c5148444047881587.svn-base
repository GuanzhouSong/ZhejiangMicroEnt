                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                           <select name="eigIndustry" id="eigIndustry">
                               ...
                               <option value="eigIndustry0">全部</option>
                           </select>
                        </div>
                    </div>
                </div>           
...
<!--         <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="3" checked="checked" >企业大类</label> -->
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="3" checked="checked" >企业分类</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="4" checked="checked" >登记机关</label>
     </div>
        ...
        <ul class="clearfix">
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="5" ></span></span>在册小微企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="6" ></span></span>新设小微企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="7" ></span></span>注销小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="8"></span></span>在册小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="9"></span></span>新设小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="10"></span></span>新设小微企业平均注册资本</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="11"></span></span>新设小微企业负责人平均年龄</label>
            </li>
<!--             <li> -->
...
<!--                 <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>负责人90后的新设小微企业数</label> -->
            ...
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="12"></span></span>负责人是省内的新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="13"></span></span>股东全为自然人的新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="14"></span></span>在册企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>新设企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="16"></span></span>注销企业数</label>
            </li>            
        </ul>
