...
<div class="layder-bd ">
    <div class="form-list name-specification jyexpire">
	            ...
	            <label class="item-name col-3">* 审批事项编码：</label>
	            <div class="col-4">
	           ...
	           <div class="form-item clearfix">
	            <label class="item-name col-3">* 审批事项名称：</label>
	            <div class="col-4">
	                <div class="ipt-box mr10">
	            ...
	            <div class="example col-5">
   	          ...
   	          <div class="form-item clearfix">
            <label class="item-name col-3"><span class="light">*</span> 审批部门：</label>
            <div class="col-4">
                <div class="ipt-box mr10">
        ...
        <div class="form-item clearfix">
            <label class="item-name col-3"><span class="light">*</span> 审批部门级别：</label>
            <div class="col-4">
                <div class="ipt-box mr10">
...
<script src="<c:url value="/js/syn/system/codeLicense/codelicense_edit_main.js"/>"></script>
<script>
    window._CONFIG = {
       _flag:'${viewFlag}',//修改标识   
