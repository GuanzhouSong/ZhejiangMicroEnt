...
/**
 * 描述:    cs_code_position_type 对应的Mapper接口.<br>
 *
 * @author framework generator
 * @date 2017年09月25日
 */
public interface CodePositionTypeMapper extends Mapper<CodePositionType> {
	 ...
	 * @throws Exception
	 */
	List<CodePositionType> selectListByParams(Map<String,Object> params);
	 ...
	 * @return
	 */
	List<CodePositionTypeDto> selectByParams(Map<String, Object> params);
