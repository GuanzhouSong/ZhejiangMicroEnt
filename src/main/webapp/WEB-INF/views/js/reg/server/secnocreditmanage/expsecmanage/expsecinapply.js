	            ...
	            columnDefs: [
				 {
				      ...
				      render: function (data, type, row, meta) {
			    		  ...
			    		  if(row.businessStatus == '2')
				    		  return "<a href='javascript:void(0)' class='detail'>详情</a><a href='javascript:void(0)' class='edit'>修改</a>";
	    ...
	    function bind() {
	        util.bindEvents([ {
                ...
                handler: function () {
                	var data = table.row($(this).closest('td')).data();
                	http.httpRequest({
                		url:'/reg/server/seriouscrime/judgState',
