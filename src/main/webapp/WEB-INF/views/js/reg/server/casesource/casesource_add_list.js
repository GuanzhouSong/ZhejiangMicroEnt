require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function bind() {
        util.bindEvents([{
            ...
            event: 'click',
            handler: function () {
            	window.location.href = window._CONFIG.chooseUrl+ "/server/casesource/list";
              }
        },{
            el: '#addBtn',
            event: 'click',
            handler: function () {
            	...
            	if(checkFlag){
	                layer.dialog({
	                    title: '添加',
	                    area: ['63%', '90%'],
	                    content: window._CONFIG.chooseUrl+'/server/casesource/addOrEditView?priPID='+data.priPID,
