    ...
    function (layer, dataTable, util, http, handlebars) {
        ...
        function init() {
            ...
            if (entTypeCatg != 50 && entTypeCatg != 16 && entTypeCatg != 17) {
                var imReportType =$("#repType").val();//修改获取 lijixiang
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        layer.dialog({ 
                        	  area: ['90%', '60%'],
                            title: "知识产权出质",
                            content: "/reg/server/iminfo/showippldg?pleID=" + this.id + "&priPID=" + this.title
                        });
                    }
                },
                {
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        layer.dialog({
                            title: '股权变更详情',
                            area: ['80%', '50%'],
                            content:"/reg/server/iminfo/showinvsralt?invAltID=" + this.id + "&priPID=" +this.title,
                ...
                },
                {
                    ...
                    handler: function () { 
                        layer.dialog({  
                            area: ['80%', '50%'],
                            title:"行政许可详情",
                            content: "/reg/server/iminfo/showpermit?licID=" + this.id + "&priPID=" +this.title
                        });
                ...
                },
                {
                    ...
                    handler: function () { 
                        layer.dialog({  
                        	  area: ['90%', '50%'],
                            title:"行政处罚详情",
                            content: "/reg/server/iminfo/showcase?caseNO=" + this.id + "&priPID=" +this.title
                        }); 
                    }
                },
                {
                	...
                	handler:function(){
                		 var priPID = $("#priPID").val(); 
                		location.href="/reg/server/iminfo/createPdf?priPID="+priPID+"&leRep="+$('#leRep').text()
                		+"&tel="+$('#tel').text()
                		+"&liaName="+$('#liaName').text()
                		+"&liaTel="+$('#liaTel').text()
                		+"&imPubDate="+$('#imPubDate').text();
