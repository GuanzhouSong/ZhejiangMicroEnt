require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initDataTable() {
        ...
        table = dataTable.load({
            ...
            showIndex: true,
            ajax: {
                url: window._CONFIG.chooseUrl+'/server/opanomaly/pubopanomaly/selectPubOpanoMalySfcSearchListJSON.json',
                data: function (d) {
        ...
        util.bindEvents([{
        ...
        },
            {
                ...
                handler: function () {
                    ...
                    var url = window._CONFIG.chooseUrl+"/server/opanomaly/pubopanomaly/pubOpanoMalySearchViewPage?busExcList=" + data.busExcList;
