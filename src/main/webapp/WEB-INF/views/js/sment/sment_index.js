require(['component/iframeLayer', 'common/util', 'common/http','handlebars', 'jquery', 'common/validateRules', 'metisMenu', 'contabs', 'jquery.layout', 'jquery.nanoscroller'], function (layer, util, http, handlebars) {
    ...
    function setHeight() {
        var h = $(window).height();
        $('.J_mainContent').css('height', h - $('.J_mainContent').offset().top - 41 + 'px');
    }
            ...
            },
            {
                ...
                handler: function () {
                    layer.dialog({
                        ...
                        skin: 'custom-class',
                        area: ['830px', '384px'],
                        content: '/sment/server/sysuser/editPsw',
                        callback: function (data) {
                            if (data['status'] == 'success') {
                                location.assign('/sment/login/logout');
                            }
                        }
                    })
                }
    ...
    function getSearchList() {
        ...
        http.httpRequest({
            type:'get',
             url: '/sment/login/syspermision/searchMenu',
