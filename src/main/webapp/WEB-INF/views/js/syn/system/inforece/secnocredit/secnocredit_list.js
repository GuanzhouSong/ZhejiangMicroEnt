require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery', 'jquery.serialize', 'laydate'], function (layer, dataTable, util, http, handlebars) {
    ...
    function initDataTable() {
        table = dataTable.load({
            ...
            async: false,
            ajax: {
                url: '/syn/inforece/secnocredit/nocreditlist.json',
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'regNO', width: '20px',className: 'center'},
                {data: 'estDate', width: '200px'},
                {data: 'addSecNo', width: '20px', cut: {length: 20, mark: '...'}},
                {data: 'addSecDate', width: '20px'},
                {data: 'addSecCause', width: '20px', cut: {length: 20, mark: '...'}},
                {data: 'addSecOrg', width: '20px'},
    ...
    function count_downinfo(searchParams) {
        ...
        http.httpRequest({
            url: '/syn/inforece/secnocredit/downlist',
            serializable: true,
            data: searchParams,
            type: 'post',
    ...
    function down(priPID,id){
    	http.httpRequest({
            ...
            serializable: false,
            data: {'priPID':priPID,'type':'2','id':id},
            type: 'post',
            success: function (data) {
    ...
    function bind() {
        util.bindEvents([{
            ...
            handler: function (e) {
                ...
                if ($(target).closest('td').index() == 10)return;
