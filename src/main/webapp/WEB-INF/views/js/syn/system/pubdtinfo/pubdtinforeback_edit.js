require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate'], function (layer, dataTable, util, http,handlebars) {
    ...
    function check(){
    	...
    	if(reassignType == '1'){  //重新指派 验证重新指派机关
    		...
    		if(deptname == ""){
                layer.msg("请您选择重新指派审批机关!", {icon: 7,time: 1000});
    			return false;
    		}
            ...
            handler: function () {
            	if(check()){
            		...
            		layer.confirm(msg, {icon: 2, title: '提示'}, function () {
        	    		...
        	    		if($("input:radio[name='reassignType'][checked]").val()=='2'){//如果是回退操作提交  ，移除审批部门编码和部门名称的赋值
...
//        	    		debugger
    	                http.httpRequest({ 
    	                    url: window._CONFIG.chooseUrl+'/pubdtinfo/doreback',
    	                    serializable: true,
    	                    data: formParam  ,
    	                    type: 'post',
