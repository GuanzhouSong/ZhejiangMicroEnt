require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate','jquery.validate','common/validateRules','common/ajaxfileupload'], function (layer, dataTable, util, http,handlebars) {
	   ...
	   //事件绑定
	    function bind() {
	        util.bindEvents([ {
	            ...
	            event: 'click',
	            handler: function() {
	            	layer.msg("您取消了编辑！", {time: 1000}, function() {window.history.go(-1);});
	            }
	        }, {
	            el: '#add_detail',
	            event: 'click',
