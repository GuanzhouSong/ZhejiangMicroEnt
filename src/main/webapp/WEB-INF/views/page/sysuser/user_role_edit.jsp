    ...
    <div class="form-box mb5">
        <div class="form-list">
            ...
            <c:if test="${sessionScope.session_sys_user.userType=='1'}">
               <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5">层级：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select  id="levels" name="levels"> 
                            <option value="">全部</option>
                               <c:choose>
                                  <c:when test="${uservest=='0'|| uservest=='4'}">
	                                <option value="0">省级</option>
	                                <option value="3">市级</option>
	                                <option value="2">县级</option>
	                                <option value="1">所级</option>
                                  </c:when>
                                  <c:when test="${uservest=='3'}">
	                                <option value="3">市级</option>
	                                <option value="2">县级</option>
	                                <option value="1">所级</option>
                                  </c:when>
                                  <c:when test="${uservest=='2'}">
	                                <option value="2">县级</option>
	                                <option value="1">所级</option>
                                  </c:when>
                                  <c:otherwise>
...
<script src="/js/business/sysuser/user_role_edit.js"></script>
<script>
    window._CONFIG = {
