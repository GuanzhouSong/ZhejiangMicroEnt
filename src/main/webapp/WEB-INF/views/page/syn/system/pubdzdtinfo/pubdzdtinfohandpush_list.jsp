...
<div class="tabbale" data-component="tab">
                ...
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt" readonly="readonly" id="exaName" value="" placeholder="请选择备案事项"/>
    ...
    <script src="<c:url value="/js/syn/system/pubdzdtinfo/pubdzdtinfohandpush_list_main.js"/>"></script>
</body>
</html>