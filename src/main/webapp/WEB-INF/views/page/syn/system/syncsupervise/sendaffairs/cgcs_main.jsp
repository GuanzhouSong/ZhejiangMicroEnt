...
<div class="tabbale" id="cgcs-tab">
    <div class="tab-header tab-chaogao">
        <ul class="clearfix">
            <li class="tab-selected"><span id="sendTab" class="tab-item">我发起的协同事务提请</span></li>
            <li><span id="acceptTab" class="tab-item">我接收的协同事务提请</span></li>
        </ul>
    </div>
    <div class="tab-content mb20">
        <div id="sendbody" class="tab-panel">
            ...
            <div class="clearfix mb5">
                ...
                <span class="light-yellow fr mt5">共发起<span id="cgcstotal"></span>条协同事务提请，其中<span id="cgcsdshNum"></span>条待审核，<span
                        id="cgcsshthNum"></span>条审核退回，<span id="cgcsycgfkzNum"></span>条已协同事务提请反馈中，<span
                        id="cgcsycgfkwcNum"></span>条已协同事务提请反馈完成，<span id="cgcsqxcgNum"></span>条取消协同事务提请，<span
                        id="cgcscgwc"></span>条协同事务提请已完成</span>
            </div>
        ...
        <div id="acceptbody" class="tab-panel">
                    ...
                    <div class="form-box mb5">
                        <div class="form-list">
                            <div class="form-item clearfix">
                                ...
                                <div class="col-4">
                                    <label class="item-name col-5">协同事务提请状态：</label>
                                    <div class="col-6">
                                        <div class="ipt-box col-12">
                            ...
                            <div class="form-item clearfix mb10">
                                <div class="col-4">
                                    <label class="item-name col-5">协同事务提请发起部门：</label>
                                    <div class="col-6">
                                        <div class="ipt-box col-12">
                                ...
                                <div class="col-4">
                                    <label class="item-name col-5">协同事务提请发起人：</label>
                                    <div class="col-6">
                                        <div class="ipt-box col-12">
            ...
            <div class="clearfix mb5">
                <span class="light-yellow fr mt5">共发起<span id="cgcsceeptTotal"></span>条协同事务提请，其中<span
                ...
                <div class="iframe-wrap">
                    <table id="accept-cgcs-table" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <th>协同事务提请最新处理日期</th>
                            <th>协同事务提请发起部门</th>
                            <th width="20%">协同事务提请发起部门联系人</th>
                            <th width="20%">协同事务提请发起部门联系电话</th>
                            <th width="20%">协同事务提请发起部门传真</th>
                            <th width="20%">协同事务提请发起部门邮箱</th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
<script src="/js/syn/system/sendaffairs/cgcs_main.js"></script>
</body>
</html>