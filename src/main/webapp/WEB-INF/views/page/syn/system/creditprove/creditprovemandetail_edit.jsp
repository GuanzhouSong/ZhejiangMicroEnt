     ...
     <div class="mt40" id="grgszm_one" style="display: none;">
         <div  style="width:1375px; margin:0 auto; page-break-before:auto; height:70px; *height:600px; _height:600px;position: relative;">
		     <p class=p0 style="margin-bottom: 0pt; margin-top: 50pt;margin-left: 900pt;">
				<span style="mso-spacerun: 'yes'; font-weight: bold; font-size: 10.5000pt; font-family: '宋体';"><o:p>查证单号：${creditProveListDtoList[0].proveNo}</o:p></span>
			 </p>
...
<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; text-align: right; line-height: 28.0000pt;" >
	<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';" > 
	  ${creditProveListDtoList[0].setDept}
	</span>
	<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><o:p></o:p></span>
</p>
<p class=p0 style="margin-bottom: 0pt; margin-top: 0pt; text-align: right; line-height: 28.0000pt;" >
	<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';" > 
	 <fmt:formatDate value="${creditProveListDtoList[0].setDate}" pattern="yyyy年MM月dd日   HH:mm:ss"/>
	</span>
	<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';"><o:p></o:p></span>
</p>
...
<script src="/js/syn/system/creditprove/creditprovemandetail_edit.js"></script>
</body>
</html>