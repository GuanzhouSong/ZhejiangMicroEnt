...
<div class="pd20 clearfix">
    <h4 class="h4-title light" >提示：文件对应审批部门是指:国家法律法规规定本应该负责审批监管的部门,实际审批部门是指:实际落实审批监管的部门;系统会把信息推送到实际审批部门名下  
    </h4>
    <table border="0" cellspacing="0" cellpadding="0" class="table-horizontal mb10">
        ...
        <c:if test="${flag==1 }">
	        ...
	        <tr>
	            <td class="bg-gray right " width="17%"><span class="light">* </span> 文件规定对应审批部门</td>
	            <td width="40%">
	                <div class="ipt-box col-12"> 
	            ...
	            <td><div class="ipt-box col-12">
	                    <select id="licDeptTypeText" style="width: 100px;">
	        ...
	        <tr>
	         ...
	         <tr>
	            <td class="bg-gray right " width="10%">* 是否推送同级</td>
	            <td width="40%">
	                <div class="ipt-box col-12"> 
	                    <select  style="width: 100px;" id="isSameGovTem">
        ...
        <c:if test="${flag==2 }">
	        ...
	        <tr>
	          ...
	          <tr>
	            ...
	            <td class="bg-gray right" width="15%"><span class="light">* </span> 实际审批部门</td>
	            <td><div class="ipt-box col-12"> 
	                     <input type="text" id="orgNameText"  class="fl ipt-txt" value="${licDeptList[0].orgName}"  disabled="disabled">
 	                     <span class="add-icon"  id="selectAdDept"><i></i></span>
	                </div>
	        ...
	        <tr>
	            ...
	            <td class="bg-gray right" width="10%"><span class="light">* </span> 是否推送同级</td>
	            <td><div class="ipt-box col-12">
	                    <select  style="width: 100px;" id="isSameGovTem">
		                   <option value="1">是 </option>
		                   <option value="0" selected="selected">否</option>
...
<script src="<c:url value="/js/syn/system/licdept/licdept_edit_main.js"/>"></script>
 <script>
    window._CONFIG = {
       _flag:'${flag}', //修改标识   
