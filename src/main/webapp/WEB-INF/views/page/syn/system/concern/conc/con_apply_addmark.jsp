        ...
        <div class="col-4">
            <dl class="identification">
                ...
                <c:forEach items="${markList}" var="list" varStatus="inx">
		                <dd><label><input type="radio" class="markRadio" name="markNo" ${inx.count == 1?'checked':''} value="${list.markNo}"><span>${list.markName }</span></label></dd>
					</c:forEach>  
            </dl>
        </div>
        <div class="col-6">
...
<script src="/js/syn/system/concern/conc/con_apply_addmark.js"></script>
</body>
</html>