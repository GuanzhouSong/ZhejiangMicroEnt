...
<div class="pd20 clearfix">
     <h4 class="h4-title">企业信息</h4>
       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mb5">
        ...
        <!-- 已接收 -->
		<c:if test="${ pubDtInfoDto.acceptName != null}">
	    ...
	    <!-- 已认领 -->
	    <c:if test="${pubDtInfoDto.claimName != null}">
	    ...
	    <!-- 已回退 -->
	    <c:if test="${pubDtInfoDto.reassignName != null && pubDtInfoDto.reassignType == '2' }">
		...
		<tr>
		    ...
		    <td>
		     <c:if test="${pubDtInfoDto.reassignCode==0}">经营范围内无此审批事项</c:if>
		     <c:if test="${pubDtInfoDto.reassignCode==1}">经营范围不在审批部门的管辖范围内</c:if>
		     <c:if test="${pubDtInfoDto.reassignCode==2}">地址不在审批部门的管辖范围内</c:if>
		     </td>
		</tr>
		<tr>
	    ...
	    <!-- 已回退 -->
	    <c:if test="${pubDtInfoDto.reassignName != null && pubDtInfoDto.reassignType == '1' }">
       ...
       <div id ="btnDiv" style="display:none;">
		...
		<c:if test="${pubDtInfoDto.checkDeptType == '1'}">
	     ...
	     <div class="light-info center"><span class="light f14">企业所涉审批事项确认由你部门审批请点击“认领”，否则请点击“回退”</span></div>
		 </c:if>
		...
		<c:if test="${pubDtInfoDto.checkDeptType != '1'}">
           ...
           <input type="hidden" name="checkDeptType" value="${pubDtInfoDto.checkDeptType}"/>
		    ...
		    <div class="light-info center"><span class="light bold f14">企业所涉审批事项确认由你部门接收请点击“接收”。</span></div>					    
		</c:if> 
	  </div>   
</div>
</body>
...
<script src="/js/syn/system/pubdtinfo/pubdtinforeceive_edit.js"></script>
</html>