...
<div>
        ...
        <div class="col-4">
            <dl class="identification">
                ...
                <c:forEach items="${markList}" var="list" varStatus="inx">
		                <dd><label><input type="radio" class="markRadio" name="markCode" ${list.markNo == dto.markCode?'checked':''} value="${list.markNo}"><span>${list.markName }</span></label></dd>
				</c:forEach>
            </dl>
        </div>
        <div class="col-6">
    ...
    <div class="mb5 clearfix">
        ...
        <input type="button" id="add" class="btn btn-sm mr5" supState="${supState}" markCode="${markCode}" batchNO="${batchNO}"
					supCheckState="${supCheckState}" value="添加">
	...
	<div>
        ...
        <table id="hx-table" border="0" cellspacing="0" cellpadding="0" class="table-row perc-100 mt30 nowrap" width="100%">
            <thead>
            <tr>
                <th ><input type="checkbox" id="chbAll">选择</th>
                <th >批次号</th>
                <th >企业名称</th>
                <th >注册号</th>
                <th >统一信用代码</th>
...
<script src="/js/syn/system/supervise/sup/sup_apply_batch_mod.js"></script>
</body>
</html>