    ...
    <div class="mt10">
        <div class="tabbale" data-component="tab">
            <div class="tab-content">
              	...
              	<input name="auditUserName" type="hidden" value="${pubScentResultDto.auditUserName }"/>
                    <div class="mt10">
...
<!-- 	                       			<a href="javascript:void(0);" id="addAgent">添加</a> -->
	                       		...
	                       		<tr>
	                       			...
	                       			<td><input disabled="disabled" type="text" value="${pubScentResultDto.auditUserName }"/></td>
	                       		</tr>
	                       		<tr>
