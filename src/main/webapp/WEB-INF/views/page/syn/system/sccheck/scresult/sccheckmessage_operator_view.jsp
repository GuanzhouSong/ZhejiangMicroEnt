    ...
    <div class="c-remind-wrap">
        ...
        <div class="c-remind-body">
            <div class="c-r-b-wrap">
                <div class="c-r-title">
                    <h2>企业抽查检查提醒</h2>
                    <p class="c-r-date">发送日期：<span class="span_sendDate"><fmt:formatDate value="${pList[0].checkDate}" type="date" pattern="yyyy年MM月dd日"/></span></p>
                    <p class="c-r-tel">联系客服  400-888-4636</p>
                    <p class="c-r-msg">${pList[0].checkResult}</p> 
