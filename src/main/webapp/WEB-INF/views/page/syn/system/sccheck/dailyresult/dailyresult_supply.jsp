                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
                            <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td width="35%">
		                                <input type="text" name="cidRegNO" readonly="readonly" value="${dailyInspectResult.cidRegNO }" size="35">
	                                </td>
	                            </tr>
	                            <tr>
...
<script src="/js/syn/system/sccheck/dailyresult/dailyresult_supply.js"></script>
</body>
</html>