                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       		...
	                       		<tr>
	                       			...
	                       			<td colspan="3"><input id="alterContent" name="alterContent" type="text" value="${dailyInspectResult.alterContent }">
	                       			</td>
	                       		</tr>
	                       		<tr>
	                       			<td class="bg-gray right">修改人员</td>
	                       			<td><input readonly="readonly" name="alterUserName" type="text" value="${sysUserDto.realName }">
	                       			</td>
	                       			<td class="bg-gray right">修改日期</td>
	                       			<td><input name="alterDate" readonly="readonly" type="text" value="<fmt:formatDate value='${now }' pattern='yyyy-MM-dd'/>"/></td>
	                       		</tr>
...
<script src="/js/syn/system/sccheck/dailyresult/dailyresult_alter.js"></script>
</body>
</html>