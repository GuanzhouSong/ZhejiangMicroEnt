...
<div class="pd20 clearfix">      
		<div class="light-info left"><span class="light bold f14">明确企业后置审批事项的审批部门时请选择“重新指派”，否则请选择“回退”。</span></div>							
        <form id="form">
        ...
        <tr id="recheck">
			<th class="bg-gray right">重新指派审批机关<span style="color:red;">*</span></th>
			<td colspan="3">
		...
		<tr id="reback"  style="display: none">
            ...
            <select name="reassignCode" id = "reassignCode" required >
              ...
              <option value="0">经营范围内无此审批事项</option>
		...
		<tr>
			<th class="bg-gray right">备注（限500字以内）<span style="color:red;">*</span></th> 
		    <td colspan="3">
	         <div class="ipt-box">
...
<script src="/js/syn/system/pubdtinfo/pubdtinforeback_edit.js"></script>
</html>