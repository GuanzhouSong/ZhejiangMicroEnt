...
<div class="iframe-wrap">
    <p class="tip-info left mb5 mt10">
        <input type="button" id="addNewGrouop" value="新建检查小组" class="btn">&nbsp;&nbsp;
        <input type="button" id="modifyNewGrouop" value="修改检查小组" class="btn">&nbsp;&nbsp;
        <input type="button" id="deleteNewGrouop" value="删除检查小组" class="btn">&nbsp;&nbsp;
...
<script src="/js/syn/system/sccheck/checkgroup/checkgroup_list.js"></script>
</body>
</html>
