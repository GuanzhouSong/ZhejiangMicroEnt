    ...
    <div class="main">
        <div class="actual-wrap actual-w clearfix">
            ...
            <div class="map-box map-taizhou fl">
                ...
                <div class="city city-0"><i></i>台州市本级<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 1}">
                <div class="city city-1">天台县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 2}">
                <div class="city city-2">仙居县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 3}">
                <div class="city city-3">黄岩区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 4}">
                <div class="city city-4">玉环县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 5}">
                <div class="city city-5">三门县<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 6}">
                <div class="city city-6">临海市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 7}">
                <div class="city city-7">椒江区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 8}">
                <div class="city city-8">集聚区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 9}">
                <div class="city city-9">开发区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 10}">
                <div class="city city-10">路桥区<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                <c:if test="${status.index  == 11}">
                <div class="city city-11">温岭市<span>${pubScentDto.specialNum }</span></div>
                </c:if>
                </c:forEach>
            </div>
