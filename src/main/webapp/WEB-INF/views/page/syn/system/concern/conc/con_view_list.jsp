        ...
        <div class="form-list">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" id="localAdm" class="ipt-txt clx" value="" readonly/>
                            <input type="hidden" id="localAdmCode" name="regOrgDeptCode" class="clx" value=""/>
                ...
                <div class="col-4">
                    ...
                    <div class="col-8">
                        <div class="ipt-box col-12">
                            <input type="text" id="regOrg" class="ipt-txt clx" value="" readonly/>
                            <input type="hidden" id="regOrgCode" name="regUnitDetpCode" class="clx" value=""/>
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="conState" class="clx">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    <label class="item-name col-4">审核状态：</label>
                    <div class="col-8">
                        <div class="ipt-box col-12">
...
<div>
    <table id="con_view_table" border="0" cellspacing="0" cellpadding="0" class="table-row perc-100 nowrap">
        <thead>
        <tr>
            <th>序号</th>
            <th>审核状态</th>
...
<script src="/js/syn/system/concern/conc/con_view_list.js"></script>
</body>
</html>