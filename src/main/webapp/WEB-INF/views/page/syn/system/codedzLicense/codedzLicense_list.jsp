...
<div class="tabbale" data-component="tab">
    ...
    <div class="clearfix mb5">
        ...
        <p class="fl" style="display: none"><input type="button" class="btn btn-sm mr5" value="生成备案对照数据"
                                                   id="executeLicDeptData"></p>
    </div>
    <div class="light-info mb5">
            <p class="light">提示：后置备案事项的数据和准入系统保持一致，若非准入系统的后置备案事项有变化，请勿执行新增、修改、删除操作</p>
    ...
    <script src="/js/syn/system/codedzLicense/codedzlicense_list_main.js"></script>
</body>
</html>