...
<body class="pd10">
		  ...
		  <form id="entSearchForm">
			...
			<div class="form-item clearfix">
				<div class="col-4">
					...
					<div class="col-6">
						<div class="ipt-box col-12">
						   <input type="text" class="ipt-txt clx" id="industryCoName"  style="height: 30px;" name="" value="" readonly>
				...
				<div class="col-4">
					...
					<div class="col-6">
						<div class="ipt-box col-12">
						   <input type="text" class="ipt-txt clx" id="entType"  style="height: 30px;" name="" value="" readonly>
			...
			<div class="js-show" style="display:none;">
					...
					<div class="col-4">
						...
						<div class="col-6">
						   <div class="ipt-box col-5">
                                 <input type="text" class="ipt-txt clx" onclick="laydate();" name="estDateStart" readonly>
                           </div>
				...
				<div class="form-item clearfix">
					...
					<div class="col-4">
					  ...
					  <div class="col-6">
						   <div class="ipt-box col-5">
                                 <input type="text" class="ipt-txt clx" onclick="laydate();" name="apprDateStart" readonly>
                           </div>
                            <span class="item-txt col-2"><i class="line-icon"></i></span>
                           <div class="ipt-box col-5">
	...
	<script src="/js/syn/system/risk/entwarninfo/entwarnapply_addent.js"></script>
</body>
</html>