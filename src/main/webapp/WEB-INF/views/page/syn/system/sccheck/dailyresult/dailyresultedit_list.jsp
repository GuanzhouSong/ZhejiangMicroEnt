...
<body class="pd10">
    <div class="pd10 bg-gray" style="margin-top: 10px;">
       <div class="form-list pdr10">
         ...
         <div id="hideorshow" style="display: none">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-4">录入员：</label>
                    <div class="col-7">
                        <div class="ipt-box col-11">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon"
                                   onclick="laydate()" readonly="readonly"
                                   name="alterDateStart" value=""/>
                        </div>
                        <span class="item-line col-05">-</span>
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon"
                                   onclick="laydate()" readonly="readonly"
                                   name="alterDateEnd" value=""/>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <label class="item-name col-5">修改员：</label>
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            <input type="text" class="ipt-txt" name="alterUserName" value=""/>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <div class="light-info mb5 mt5">
    <span class="light">提示：此处可对已录入的日常检查信息进行修改。 日常检查结果信息不对外公示。</span>
 </div>
<div class="tip-info">
	<div class="right">
		<label class="light-blue">查询结果</label>：
		已录入<label id="alreadyinput" class="light-blue">0</label>条，
		其中未完结<label id="notover" class="light-blue">0</label>条，
...
<script src="/js/syn/system/sccheck/dailyresult/dailyresultedit_list.js"></script>
</body>
</html>