...
<input type="hidden" id="randomType" name="randomType" value="1">
<div class="form-box mb5">
	 <div class="clearfix mb5" id="waitrandom">
    	<p class="fl">
<!--     	<input type="button" class="btn btn-sm" id="addPage" value="添加检查对象"> -->
    	<input type="button" class="btn btn-sm" id="exportSpecial" value="添加专项检查对象名单">
...
<script src="/js/syn/system/sccheck/scentback/crossRandomEnt_edit.js"></script>
</html>