        ...
        <div class="tabbale" data-component="tab">
            <div class="tab-header type-tab clear pdb10 border-bottom">
                ...
                <ul class="clearfix">
                    ...
                    <li><span class="tab-item"><a id="other">其它情况抄告</a></span></li>
                </ul>
            </div>
                ...
                <div class="tab-panel tab-panel-show">
                    <div class="">
                        <div class="print-nocard">
                            <h3>
                                <p id="copytitle">部门抄告单（无证无照信息）</p>
                            </h3>
                            <p class="right print-data">抄告发起日期：${date}</p>
                                            ...
                                            <div class="ipt-box">
                                                ...
                                                <div class="col-10">
                                                    <input id="acceptDepartNames" class="ipt-txt" type="text"
                                                           style="border:0;" name="acceptDeptNames" placeholder="请选择抄送部门"
                                                           readonly/>
                                                </div>
...
<script>
		if("${sysUser.userType}" == "1"){
			 window._CONFIG = {
		    		_urlHead:'/reg/server/copysend/',
		    		_illegalitemUrlHead:'/reg/server/illegalitem/',
		     }
		}else{
			window._CONFIG = {
		    		_urlHead:'/syn/copysend/',
...
<script src="/js/syn/system/copysend/cgcs_add.js"></script>
</body>
</html>