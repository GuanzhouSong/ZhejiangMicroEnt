...
<div class="pd20 clearfix">
    <div class="light-info right"><span class="light bold f14">企业所涉审批事项确认由你部门接收请点击“接收”。</span></div>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="table-horizontal mb10">
        <tbody>
        <tr>
            <td class="bg-gray right light" width="10%">接收人</td>
            <td width="40%">
                丽水公安
            </td>
            <td class="bg-gray right" width="10%">接收信息</td>
            <td>2014年11月14</td>
        </tr>
        </tbody>
    </table>
    <div class="center">
        <input type="button" class="btn" value="接 收">
    </div>
    <div class="light-info right"><span class="light bold f14">企业所涉审批事项确认由你部门接收请点击“接收”。</span></div>
</div>
</body>
