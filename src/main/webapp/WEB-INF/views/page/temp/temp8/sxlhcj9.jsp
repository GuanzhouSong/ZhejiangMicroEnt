    ...
    <div class="creat-copy">
        <div class="tabbale" data-component="tab">
            <div class="tab-header type-tab clear pdb10 border-bottom">
                ...
                <ul class="clearfix">
                    <li class="tab-selected"><span class="tab-item"><a href="javascript:void(0);">企业</a></span></li>
                    <li><span class="tab-item"><a href="javascript:void(0);">自然人</a></span></li>
                </ul>
            </div>
            <div class="tab-content">
                <div class="tab-panel tab-panel-show">
                    <div class="">
                            ...
                            <div class="bg-gray3">
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt30">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tb-form-hd" width="125px">
                                            惩戒事由
                                        </td>
                                        <td>
                                            无证无照
                                    ...
                                    <tr>
                                        ...
                                        <td class="pd0">
                                            ...
                                            <div class="radio-box">
                                                <input type="checkbox" class="ml15">终身
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tb-form-hd">惩戒当事人列表</td>
                                    ...
                                    <tr>
                                        <td class="tb-form-hd" rowspan="3">联系人</td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt10 center">
                                    <tbody>
                                    <tr>
                                        <td colspan="5" class="blue-title">历史记录</td>
                                    </tr>
                                    <tr>
                                        <td width="50px">1</td>
                                        <td width="150px">2016/10/08  14:30:29</td>
                                        <td width="100px">汇信维护员</td>
                                        <td width="80px">审核退回</td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="gray-title">
                                            审核意见：
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <p class="center mt20"><input type="button" class="btn mr20" value="打 印"><input type="button" class="btn mr20" value="提交审核"><input type="button" class="btn mr20" value="返 回"></p>
                    </div>
                </div>
            </div>
        </div>
