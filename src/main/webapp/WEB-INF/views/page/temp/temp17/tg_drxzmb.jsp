    ...
    <div class="sidebar">
        <ul class="navbar">
            <li><a href="javascript:void(0)" class="info selected">信息提供</a>
                <ul class="subnavbar">
                    <li><a href="javascript:void(0)" >在线录入</a></li>
                    <li><a href="javascript:void(0)" class="selected">批量导入</a></li>
...
<script>
    $(function () {
        $('.select-mb dd span').click(function () {
            $(this).parent('dd').addClass('active').siblings().removeClass('active');
        })
    })
</script>
</body>
