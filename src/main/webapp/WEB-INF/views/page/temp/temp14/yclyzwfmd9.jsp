...
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    ...
    <tr>
        ...
        <td>331021620043077</td>
    </tr>
    <tr>
        <td class="bg-gray right" width="8%">法定代表人（负责人）</td>
        <td width="28%"></td>
...
<table cellpadding="0" cellspacing="0" border="0" class="table-row mb10">
    ...
    <th class="bg-gray" width="35%">列入异常机关</th>
...
<h5 class="com-info-title left pdl10">列入严违信息<a href="javascript:void(0);" class="fr mr10">收起<i class="tran-icons"></i></a><a class="fr mr10">异常类列入严违历史记录</a></h5>
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    <tbody>
    <tr>
...
<h5 class="com-info-title left pdl10">移出严违信息<a href="javascript:void(0);" class="fr mr10">收起<i class="tran-icons"></i></a></h5>
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    <tbody>
    <tr>
        <td class="bg-gray right" width="11%">
...
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal">
    ...
    <tr>
        <td class="bg-gray right" width="15%">初审意见  </td>
        <td colspan="5">
            <div class="col-3">
                <div class="radio-box">
                    <label for=""><input type="radio">列入 </label>
                    <label for=""><input type="radio"> 不予列入 </label>
                </div>
            </div>
            <div class="col-9">
                <div class="ipt-box">
    ...
    <tr>
        <td class="bg-gray right" width="15%">初审人  </td>
        <td></td>
        <td class="bg-gray right" width="15%"> 初审日期  </td>
        <td colspan="3"></td>
    </tr>
    <tr>
        <td class="bg-gray right" width="15%">审核意见   </td>
        <td colspan="5">
            <div class="radio-box">
                <label for=""><input type="radio">列入 </label>
                <label for=""><input type="radio"> 不予列入 </label>
    ...
    <tr>
        <td class="bg-gray right" width="15%">审核人  </td>
        <td></td>
        <td class="bg-gray right" width="15%">审核日期  </td>
        <td colspan="3"></td>
    </tr>
    </tbody>
</table>
<div class="center mt20">
    <input type="button" class="btn mr10" value="提 交">
