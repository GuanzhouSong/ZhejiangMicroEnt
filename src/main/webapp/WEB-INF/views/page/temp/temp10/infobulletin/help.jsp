...
<div class="mb20">
    <div class="mod mod-help">
        ...
        <div class="mode-help-bd">
            ...
            <h3>二、系统功能简介</h3>
            <p>本系统提供全国专业、农民专业合作社、个体工商户等市场主体信用信息的填报、公示和查询服务。</p>
            <p>1、查询市场主体信用信息，输入名称或注册号进行查询。系统支持按名称的关键词模糊查询，一次最多显示5条信息。对于无效的查询条件，将不会显示查询结果。</p>
            <p>2、市场主体填报年度报号和其他信息，通过本系统选择登记机关所在地区，点击"企业公司信息填报"进行填报。</p>
            <h3>三、信息说明</h3>
