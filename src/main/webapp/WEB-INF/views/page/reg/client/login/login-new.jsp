...
<body>
    ...
    <div class="related-link fr">
        相关链接：<a href="">浙江政务服务网</a> | <a href="">企业信用信息公示系统</a>
    </div>
</div>
            ...
            <div class="fl data-log">
                <div class="data-log-show">
                    ...
                    <div class="center log-photo">
                        ...
                        <input type="button" class="btn-common oauth" value="登录">
                    </div>
                </div>
                <!-- 政务服务网登录提示 start -->
	            <div class="fr-tab data-tab"  style="display: none">
	                ...
	                <input type="button" value="确定" class="btn btn-common" id="oauthlogin">
	                <a href="javascript:void(0);" class="oauth goback">返回</a>
	            </div>
	            <!-- 政务服务网登录提示 end -->
            </div>
            <div class="fr com-log">
                <div class="fr-tab log-tab">
                    <h4 class="clearfix"><i class=""></i>企业联络员登录<a href="javascript:void(0);" target="_blank" class="fr"  id="pubphoneapply">联络员备案申请</a></h4>
                    <form id="login-form">
                ...
                <div class="fr-tab apply-state has-aly phoneApply" style="display: none">
	                ...
	                <p>
	                    <input type="button" class="btn btn-icon oauth" value="企业数字证书登录"/>
	                    <a href="javascript:void(0);" class= "tr-center phoneApplyBtn">不，继续办理企业联络员确认手续</a>
	                </p>
    ...
    <div class="mod">
        <div class="other-info">
            <P>
                <a href="javascript:void(0);" target="_blank"><i class="notice-icon"></i>通知公告</a>
                <a href="javascript:void(0);" target="_blank"><i class="help-icon"></i>填报帮助</a>
                <a href="javascript:void(0);" target="_blank"><i class="question-icon"></i>常见问题</a>
                <a href="javascript:void(0);" target="_blank"><i class="consult-icon"></i>工商部门咨询电话</a>
                <a href="javascript:void(0);" target="_blank"><i class="server-icon"></i>企业数字证书服务</a>
            </P>
        </div>
    </div>
    <script>
