            ...
            <table width="100%" border="0" class="table-horizontal"> 
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1" style="text-align:center">
                        <div class="ipt-box"><font color="red"></font>* 标题 <br>(限150字)</div>
                    </td>
                    <td colspan="6">
                        <div class="ipt-box">
                            <textarea  style="width: 100%;height: 50px;"  ${flag==2?'disabled':''} id="consultTitle" name="consultTitle">${consultInfo.consultTitle}</textarea></div>
                    </td>
                </tr> 
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1" style="text-align:center">
                        <div class="ipt-box"><font color="red"></font>* 异议内容 <br>(限1000字)</div>
                    </td>
                    <td colspan="6">
                        <div class="ipt-box">
                            <textarea id="consultContent" name="consultContent"  ${flag==2?'disabled':''}
                ...
                <tr>
                    ...
                    <td width="180">
                        <div class="ipt-box">
                        <c:if test="${flag==2 }">
                        <fmt:formatDate value="${consultInfo.consultTime}" type="date"
                                                           pattern="yyyy-MM-dd"/>
                        </c:if>
                ...
                <tr>
	        		<td class="bg-gray right" width="100" valign="middle" class="lb_1" style="text-align:center">
                        <div class="ipt-box"> 反馈意见</div>
                    </td>
                    <td colspan="6"> 
                        <div class="ipt-box">
                             <textarea id="backContent" name="backContent" disabled="disabled"
...
<script src="<c:url value="/js/reg/client/yr/consult/consult_edit_main.js"/>"></script>
</body>
</html>
<style type="text/css">
    table.gridtable {
