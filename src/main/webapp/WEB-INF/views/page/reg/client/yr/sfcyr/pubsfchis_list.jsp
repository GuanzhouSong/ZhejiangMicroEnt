...
<script id="table-template" type="text/x-handlebars-template">
    {{#each data}}  
            <tr>
                    ...
                    <td> <a href="#" class="viewSfcHisReport" id='{{reportNo}}' title='{{anCheID}}'>详情</a>&nbsp;<a href="#" class="printSfcHisReport" id='{{reportNo}}' title='{{anCheID}}'>打印</a></td>
            </tr> 
    {{/each}} 
</script>
...
<script src="<c:url value="/js/reg/client/yr/sfcyr/sfcreportprint_list.js"/>"></script>
 <script>
    window._CONFIG = {
       _year:'${year}', //年报年度
       _pripid:'${pripid}'  //主体代码  
