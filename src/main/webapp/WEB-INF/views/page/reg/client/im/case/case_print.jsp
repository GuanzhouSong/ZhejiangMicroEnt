...
<div class="print2">
    <table>
        <tr >
            <td  colspan="5"><h2>行政处罚信息</h2></td>
        </tr>
        <tr >
            <td style="width:18%">处罚机关</td>
            <td style="width:18%">处罚决定书文号</td>
            <td style="width:18%">处罚决定书签发日期</td>
            <td style="width:18%">违法行为类型</td>
            <td style="width:18%">处罚种类</td>
        </tr>
        <c:forEach var="imCase" varStatus="status"  items="${imCaseList}">
            ...
            <tr >
                ...
                <td >
                    <fmt:formatDate value='${imCase.penDecIssDate}'
                                    pattern='yyyy-MM-dd'/>
                </td>
                <td >
                    ${imCase.illegActType}
