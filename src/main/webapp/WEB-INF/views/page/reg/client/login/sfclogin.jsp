...
<body>
        ...
        <div class="clearfix">
            <div class="fl data-log">
                <div class="data-log-show">
                    ...
                    <div class="center log-photo">
                        ...
                        <input type="button" class="btn-common keyLogin" value="登录">
                    </div>
                </div>
	            <!-- 通用提示 start -->
            ...
            <div class="fr com-log">
                <div class="fr-tab log-tab">
                    ...
                    <form id="login-form">
                	<input type="hidden" id="systemType" name="systemType" value="3">
                        <div class="usual-log">
                            <ul>
	...
	<script src="/js/reg/client/login/sfclogin_main.js"></script>
</body>
</html>