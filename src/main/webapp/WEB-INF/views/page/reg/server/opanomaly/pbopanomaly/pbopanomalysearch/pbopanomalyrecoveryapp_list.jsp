...
<div class="iframe-wrap mt10">
	<input type="button" id="add" value="新增恢复正常记载" class="btn mr20">
...
<script src="<c:url value='/js/reg/server/opanomaly/pbopanomaly/pbopanomalyrecoveryapp_list.js'/>"></script>
</body>
</html>
