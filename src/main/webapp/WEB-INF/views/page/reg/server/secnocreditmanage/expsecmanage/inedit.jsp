...
<table id="sevBreachInforTable" cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    ...
    <tr>
        ...
        <td colspan="3">
            <div class="">
                <div class="ipt-box">
                    <textarea name="addSecExplain" rows="5" >${expSeriousCrimeList.addSecExplain}
                    </textarea>
                </div>
            </div>
        </td>
    ...
    <c:forEach var="i" begin="${expSeriousCrimeList.addSecBasedNum+1}" end="9" varStatus="status">
	    <tr class="tr${status.index} tr" style="display: none;">
	        <td class="bg-gray right">依据${status.index}</td>
	        <td colspan="3" >
	        	<div class="ipt-box yj-ipt clearfix">
...
<h5 id="h5" class="com-info-title left pdl10">经办人意见信息&emsp;<a style="color: red">请于<fmt:formatDate value="${expSeriousCrimeList.addSecTerm}" pattern="yyy年MM月dd日"/>前列入严违失信名单</a></h5>
