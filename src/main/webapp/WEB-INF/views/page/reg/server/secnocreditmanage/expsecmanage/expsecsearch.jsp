                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt clearall" readonly="readonly" id="localAdmName" placeholder="请选择企业管理部门"/>
...
<div class="clearfix mb5 mt5">
    <span class="light-yellow fr mt5">查询结果：待列入<span id="dlrNum"></span>条，待移出<span id="dycNum"></span>条，待延期<span id="dyqNum"></span>条</span>
</div>
