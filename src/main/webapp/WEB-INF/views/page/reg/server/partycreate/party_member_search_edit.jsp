           ...
           <form id="entInfoFrom">
	         ...
	         <div id="entinfo" style="display: none">
	            <div class="form-item clearfix pd50">
	                <div class="col-6">
	                    <label class="item-name col-8">党组织建制：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	                            <select name="buildOrgType" id="buildOrgType">
	                                <option value="" ></option>
	                ...
	                <div class="col-6">
	                    <label class="item-name col-3">组建日期：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	                            <c:if test="${empty partyEntInfo}">
	                               <input type="text" class="ipt-txt clx pointer" name="createOrgTime" onclick="laydate()" readonly="readonly" value="${lastYearInfo.parSetTime}" />
	                            </c:if>
	                            <c:if test="${!empty partyEntInfo}">
	                               <input type="text" class="ipt-txt clx pointer" name="createOrgTime" onclick="laydate()" readonly="readonly" value="<fmt:formatDate value="${partyEntInfo.createOrgTime}" pattern="yyyy-MM-dd" />">
	                            </c:if>
	                        </div>
	                    </div>
	                </div>
	            ...
	            <div class="mb10 form-item clearfix pd50">
	                <div class="col-6">
	                    <label class="item-name col-8">党员人数（含预备党员）：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	                            <input type="text" class="ipt-txt clx" name="partyMemberNum" value="${empty partyEntInfo?lastYearInfo.numParM:partyEntInfo.partyMemberNum}">
	                        </div>
	                    </div>
	                </div>
	                <div class="col-6">
	                    <label class="item-name col-3">组建方式：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	                            <select name="buildOrgWay" id="buildOrgWay">
	                                <option value="" ></option>
               ...
               <div id="cleardom">
	                ...
	                <div class="form-item clearfix pd50">
	                    <div class="col-5">
	                        ...
	                        <div class="col-5">
	                            <div class="ipt-box col-12">
	                                <input type="text" id="identityInfo"  name="identityInfo" value="${partyMemberInfo.identityInfo}" class="ipt-txt mr5" required="required"/>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-6">
	                        ...
	                        <div class="fl radio-box">
	                            <input type="radio" id="partyPosition1" name="partyPosition" value="1" ${partyMemberInfo.partyPosition =='1'?'checked':''}/>普通党员
	                            <input type="radio" id="partyPosition2" name="partyPosition" value="2" ${partyMemberInfo.partyPosition =='2'?'checked':''}/>干部
	                ...
	                <div class="form-item clearfix pd50">
	                    <div class="col-5">
	                        ...
	                        <div class="col-5">
	                            <div class="ipt-box col-12">
	                                <input type="text" id="phoneNum"  name="phoneNum" value="${partyMemberInfo.phoneNum}" class="ipt-txt mr5"/>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-6">
	                        ...
	                        <div class="col-8">
	                            <div class="ipt-box col-12">
	                                <input type="text" id="joinPartyTime" name="joinPartyTime" onclick="laydate()" readonly="readonly"
	                       			 value="<fmt:formatDate value="${partyMemberInfo.joinPartyTime}" pattern="yyyy-MM-dd" />" class="ipt-txt mr5 pointer" required="required"/>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="form-item clearfix pd50">
	                    <div class="col-5">
	                        ...
	                        <div class="col-5">
	                            <div class="ipt-box col-12">
	                                <input type="text" id="telNum"  name="telNum" value="${partyMemberInfo.telNum}" class="ipt-txt mr5"/>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-6">
	                        ...
	                        <div class="col-8">
	                            <div class="ipt-box col-12">
	                                ...
	                                value="<fmt:formatDate value="${partyMemberInfo.orgRegisterTime}" pattern="yyyy-MM-dd" />" class="ipt-txt mr5 pointer" required="required"/>
	                            </div>
	                        </div>
	                    </div>
	                </div>
                        ...
                        <div class="col-9">
                            <div style="width: 84.3%!important;" class="ipt-box">
                                <div style="width: 15%; margin-right: 10%;" class="fl ipt-box pdr5">
                                        <input style="background-color: #F4F4F4;" id="auditName" readonly="readonly" type="text" id="keyword" class="ipt-txt mr5" name="auditName" value="${viewFlag =='1'?sessionScope.session_sys_user.realName:partyMemberInfo.auditName}">
                                </div>
...
<script src="<c:url value="/js/reg/server/partycreate/party_member_search_edit.js"/>"></script>
</body>
</html>
