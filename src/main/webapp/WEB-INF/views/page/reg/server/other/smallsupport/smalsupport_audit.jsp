        ...
        <form class="form-horizontal" id="supportform">
            ...
            <table class="table-horizontal" width="100%">
                ...
                <tr>
                    ...
                    <td width="35%">
                        <div class="ipt-box col-12">
                            <input type="text" name="helpDate" readonly disabled value="<fmt:formatDate value="${pubSamllSupport.helpDate}" pattern="yyyy-MM-dd" />" required class="ipt-txt">
                        </div>
                    </td>
                    <td width="15%" class="bg-gray right">反馈日期:</td>
                    <td width="30%">
                        <div class="ipt-box col-12">
                            <input type="text" name="feedBackTime" readonly disabled onclick="laydate()" value="<fmt:formatDate value="${pubSamllSupport.feedBackTime}" pattern="yyyy-MM-dd" />" required
                                   class="ipt-txt">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="35%">
                        <div class="ipt-box col-12">
                            <input type="text" min="0" readonly class="ipt-txt"  
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div class="ipt-box col-12">
                        <textarea cols="" id="helpContent" rows="9" readonly maxlength="500" class="required"  name="helpContent"
                ...
                <tr  style="display:none;">
                    ...
                    <td colspan="3">
                        <div class="ipt-box col-12">
                        <textarea cols="" id="helpContent" rows="9" maxlength="500" readonly name="errorCode"
                 ...
                 <tr>
                    ...
                    <td width="30%">
                    <div class="ipt-box col-12">
                    <input type="text" name="setDate"  class="ipt-txt" value="<fmt:formatDate value="${pubSamllSupport.setDate}" pattern="yyyy-MM-dd" />" readonly="readonly">
                    </div>
                    </td>
                 </tr>
                  <tr>
                    ...
                    <td width="30%">
                     <div class="ipt-box col-12">
                    <input type="text" name="auditDate" class="ipt-txt" value="<fmt:formatDate value="${pubSamllSupport.auditDate}" pattern="yyyy-MM-dd" />" readonly="readonly">
                     </div>
                    </td>
                 </tr>
                  <tr>
                    ...
                    <td width="35%">
                     ...
                     <label><input type="radio" id="checksuc" name="auditState" required value="1" ${pubSamllSupport.auditState =='1'?'checked':''}>通过</label>&nbsp;&nbsp;
                     <label><input type="radio" id="checkfal" name="auditState" required value="2" ${pubSamllSupport.auditState =='2'?'checked':''}>不通过</label>
                    </td>
