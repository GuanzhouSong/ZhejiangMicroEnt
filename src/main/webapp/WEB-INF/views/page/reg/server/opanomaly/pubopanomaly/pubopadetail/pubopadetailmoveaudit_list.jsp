            	...
            	<div id="uniCode" class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            ...
                            <label><input type="checkbox" name="isMoves"  value="2" checked="checked">更正移出</label>
                        </div>
                    </div>
                </div>                
                <div class="col-4">
...
<div class="light-info mb5 mt5">
    ...
    <span class="light">
             提示：查询范围为当前时点本局登记的在册企业。申请信息在完成审核后可打印“经营异常名录审批表”；审核结果为“予以移出、予以更正”时可打印“移出经营异常名录决定书”；予以移出的异常信息自动通过公示系统予以公示；予以更正的异常信息自动从公示系统撤回不予公示。  
    </span>
    </c:if>
    <c:if test="${systemType == '2'}">
    <span class="light">
           提示：查询范围为当前时点本局登记的在册农民专业合作社。审核后可打印“经营异常名录审批表”，予以列入情况下可打印“列入经营异常名录决定书”。予以列入信息将自动公示于公示系统。 
    </span>
    </c:if>
</div>
...
<script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopadetail/pubopadetailmoveaudit_list.js"/>"></script>
<script>
    window._CONFIG = {
