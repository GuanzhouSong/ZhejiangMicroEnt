            ...
            <div class="more-show" style="display:none">
                <div class="form-item clearfix">
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-6">
                            <div class="ipt-box col-5">
                                <input type="text" class="ipt-txt laydate-icon clx" readonly="readonly" onclick="laydate();" name="modTimeStart">
                            </div>
                            <span class="item-txt col-2"><i class="line-icon"></i></span>
                            <div class="ipt-box col-5">
                                <input type="text" class="ipt-txt laydate-icon clx" readonly="readonly" onclick="laydate();" name="modTimeEnd">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-item clearfix">
                    <div class="col-4">
                        <label class="item-name col-3">检查日期：</label>
                        <div class="col-7">
                            <div class="ipt-box col-5">
                    ...
                    <div class="col-4">
                        <label class="item-name col-5">修改人员：</label>
                        <div class="col-6">
                            <div class="ipt-box col-12">
                                <input type="text" class="ipt-txt" name="modName">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="light-info">
    <span class="light">提示：此处仅查询已录入检查结果的补报核查信息。补报核查结果信息不对外公示。</span>
