...
<!-- 				</div> -->
	...
	<div class="clearfix mb5 mt5">
	    <p class="fl"><button type="button" id="addReMove" class="btn btn-sm">新增提前解除申请</button></p>
	</div>
	...
	<script src="/js/reg/server/registmanage/qualifiedmanage/limitremoveapply_list.js"></script>
</body>
</html>