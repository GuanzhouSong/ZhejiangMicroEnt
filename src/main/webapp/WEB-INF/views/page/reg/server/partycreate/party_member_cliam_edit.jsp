           ...
           <form id="entInfoFrom">
	            ...
	            <div class="center party-whether">
	                <label class="item-name"><span class="start">*</span>个体户或企业是否自身建有党组织：</label>
	                    ...
	                    <input type="radio" class="isBuild" name="isBuildPartyOrg" value="0"  ${empty partyEntInfo?(lastYearInfo.partOrgIs==0?'checked':''):(partyEntInfo.isBuildPartyOrg ==0?'checked':'')}> 否
	            </div>
	            
	         <div id="entinfo" style="display: none">
	            <div class="form-item clearfix pd50">
	                <div class="col-6">
	                    <label class="item-name col-8"><span class="color-red">* </span>党组织建制：</label>
	                    <div class="col-4">
	                ...
	                <div class="col-6">
	                    <label class="item-name col-3"><span class="color-red">* </span>组建日期：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	            ...
	            <div class="mb10 form-item clearfix pd50">
	                <div class="col-6">
	                    <label class="item-name col-8"><span class="color-red">* </span>党员人数（含预备党员）：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	                ...
	                <div class="col-6">
	                    <label class="item-name col-3"><span class="color-red">* </span>组建方式：</label>
	                    <div class="col-4">
	                        <div class="ipt-box col-12">
	            ...
	            <div id="topInfo" class="form-item clearfix pd50">
	                    <div class="btn-box mt10 mb10">
	                        ...
	                        <input type="button" id="cliam" value="认领" class="btn mr20">
	                    </div>
	              </div>
			</form>
		
		<form id="memberform">	
		    <input type="hidden" name="UID" value="${partyMemberInfo.UID}"/>
	        <input type="hidden" name="priPID" value="${dto.priPID}"/>
            ...
            <div id="partymemberinfo" style="display: none">
                ...
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="col-5">
                            <div class="ipt-box col-12">
                                <input type="text" id="memberName"  name="memberName" value="${empty partyMemberInfo.memberName?midLeRep.name:partyMemberInfo.memberName}" class="ipt-txt mr5" required="required"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="fl radio-box">
                            <input type="radio" id="memberType1" name="memberType" value="1"   ${partyMemberInfo.memberType =='1'?'checked':''} checked="checked"/>业主
                ...
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="fl radio-box">
                           <input type="radio" id="sex1" name="sex" value="1"   ${empty partyMemberInfo.sex?(sex =='男'?'checked':''):(partyMemberInfo.sex==1?'checked':'')}/>男
                           <input type="radio" id="sex2" name="sex" value="2"   ${empty partyMemberInfo.sex?(sex =='女'?'checked':''):(partyMemberInfo.sex==2?'checked':'')}/>女
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="col-5">
                            <div class="ipt-box col-12">
                                <input type="text" id="identityInfo"  name="identityInfo" value="${empty partyMemberInfo.identityInfo?midLeRep.cerNO:partyMemberInfo.identityInfo}" class="ipt-txt mr5" required="required" readonly="readonly"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="fl radio-box">
                            ...
                            (<input type="checkbox" id="isSecretary" name="isSecretary" value="1" ${partyMemberInfo.isSecretary =='1'?'':'disabled'} ${partyMemberInfo.isSecretary =='1'?'checked':''}/>担任书记)
                        </div>
                    </div>
                </div>
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="col-5">
                            <div class="ipt-box col-12">
                                <input style="background-color: #f4f4f4;" type="text" id="keyword" readonly="readonly" class="ipt-txt mr5" name="" value="${birthDay}">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="fl radio-box">
                            ...
                            <input type="radio" id="pmDistributed2" name="pmDistributed" value="0"  ${partyMemberInfo.pmDistributed =='0'?'checked':''}/>市场
                        </div>
                    </div>
                </div>
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="col-5">
                            <div class="ipt-box col-12">
                                <input style="background-color: #f4f4f4;" type="text"  id="memberAge"  name="memberAge" value="${empty partyMemberInfo.memberAge?age:partyMemberInfo.memberAge}"  readonly="readonly" class="ipt-txt mr5">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-8">
                            <div class="ipt-box col-12">
		                         ...
		                         readonly="readonly" required="required" placeholder="如未找到，企业自身建有党组织的可直接录入"/>
                ...
                <div class="form-item clearfix pd50">
                    <div class="col-5">
                        ...
                        <div class="fl radio-box">
                            ...
                            <input type="radio" id="partyWorker2" name="partyWorker" value="0" ${partyMemberInfo.partyWorker =='0'?'checked':''}/>否
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="">
                        ...
                        <div class="col-9">
                            <div style="width: 84.3%!important;" class="ipt-box col-12">
                                <textarea style="background-color: #F4F4F4;" class="bz-tt" name="remark" cols="30" rows="10">${partyMemberInfo.remark}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="ipt-box fl">
                                        <c:if test="${viewFlag =='1'}">
				                            <input type="text" id="modifyTime" name="modifyTime" readonly="readonly" style="background-color: #F4F4F4"
				                       		 value="<fmt:formatDate value="<%=new Date()%>" pattern="yyyy-MM-dd" />" class="ipt-txt pointer mr5"/>
				                       </c:if>
				                       <c:if test="${viewFlag !='1'}">
					                        <input type="text" id="modifyTime" name="modifyTime"  readonly="readonly" style="background-color: #F4F4F4"
					                        value="<fmt:formatDate value="${partyMemberInfo.modifyTime}" pattern="yyyy-MM-dd" />" class="ipt-txt pointer mr5"/>
				                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="fr">
                                    ...
                                    <div class="fl pdr5">
                                        <div class="ipt-box">
					                       ...
					                       <c:if test="${viewFlag !='1'}">
						                        <input type="text" id="createTime" name="createTime" readonly="readonly" style="background-color: #F4F4F4"
						                        value="<fmt:formatDate value="${partyMemberInfo.createTime}" pattern="yyyy-MM-dd" />" class="ipt-txt pointer mr5"/>
					                       </c:if>
                                       </div>
                                    </div>
                                </div>
	                ...
	                <div class="form-item clearfix pd50">
	                    <div class="btn-box mt10 mb20">
	                      <c:if test="${viewFlag != '3'}">
	                        <input type="submit" id="savemember" value="提交" class="btn mr20">
	                      </c:if>
...
<script src="<c:url value="/js/reg/server/partycreate/party_member_cliam_edit.js"/>"></script>
</body>
</html>
