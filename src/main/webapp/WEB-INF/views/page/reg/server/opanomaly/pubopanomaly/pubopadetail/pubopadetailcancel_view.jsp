		...
		<form id="pubauditosaveform"  >
        	...
        	<div class="listBox2 thBg">
                    ...
                    <table class="table-horizontal">
                        ...
                        <tr>
                        	<td class="bg-gray right" valign="middle" class="lb_1"><div class="ipt-box">作出决定日期</div></td>
                            <td width="180"><div class="ipt-box"><input class="laydate-icon view-opadetail" type="text" disabled="disabled" style="width: 150px;cursor: pointer;" name="remDate" id="remDate" value="<fmt:formatDate value="${pubOpaDetail.remDate}" type="date" pattern="yyyy-MM-dd"/>" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" /></div></td>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <div class="radio-box" id="unusualRadio">
                                    <label class="font-12"><input type="radio" class="view-opadetail" disabled="disabled" name="auditOpinselect" id="yes" value="1" <c:if test="${pubOpaDetail.auditState == '1'}">checked</c:if> />予以更正（撤销）</label>
                                    <label class="font-12"><input type="radio" class="view-opadetail" disabled="disabled" name="auditOpinselect" id="no" value="2" <c:if test="${pubOpaDetail.auditState == '2'}">checked</c:if> />不予更正（撤销）</label>
                                </div>
                                <div class="ipt-box">
                                    <textarea id="auditOpin" name="auditOpin" class="txt_1 view-opadetail" disabled="disabled">${pubOpaDetail.auditOpin}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
