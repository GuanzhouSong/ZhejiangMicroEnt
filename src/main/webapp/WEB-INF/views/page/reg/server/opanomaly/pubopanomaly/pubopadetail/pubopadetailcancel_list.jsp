...
<div class="clearfix mb5 mt5">
    <p class="fl"><button type="button" id="addMove" class="btn btn-sm">新增更正（撤销）记录</button></p>
</div>
<div class="light-info mb5">
    <span class="light">提示：发现已列入生效的异常名录信息有误时可通过更正（撤销）功能进行特殊的移出异常名录处理。更正（撤销）的异常名录信息不对外公示。点击“查询”为已录入的更正（撤销）记录信息列表。审核通过后可打印“经营异常名录审批表”。</span>
    <i class="xbt-icon close"></i>
</div>
<table id="user_table" border="0" cellspacing="0" cellpadding="0" class="table-row" style="width: 100%;white-space: nowrap;"  cellspacing="0" >
     <thead>
     <tr>
...
<script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopadetail/pubopadetailcancel_list.js"/>"></script> 
<script>
    window._CONFIG = {
