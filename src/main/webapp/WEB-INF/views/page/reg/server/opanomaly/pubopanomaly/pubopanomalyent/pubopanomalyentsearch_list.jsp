...
<div class="tabbale" data-component="tab">
    ...
    <div class="light-info mt5">
        <span class="light">提示：查询范围仅限截止当前有过列入异常记录的企业。</span>
        <!-- <i class="xbt-icon close"></i> -->
    </div>
    <p class="tip-info left mb5">查询结果：
        列入并公示企业<span id="isPubCount" class="light-blue">0</span>家,
        其中列入未移出企业<span id="isInAndNotOutCount" class="light-blue">0</span>家,
        列入已移出企业<span id="isInAndIsOutCount" class="light-blue">0</span>家。
    </p>
    ...
    <script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopanomalyent/pubopanomalyentsearch_list_main.js"/>"></script>
</body>
</html>