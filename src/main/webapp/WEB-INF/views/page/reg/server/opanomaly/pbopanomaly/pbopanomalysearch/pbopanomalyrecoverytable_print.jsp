...
<div class="mod mod-print" style="position:relative; bottom: 30px;">
    ...
    <table class="table-print" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            ...
            <td width="37%" class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">${pubPbOpadetailDto.entName}</td> 
        </tr>
        <tr>
            <td style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">注册号</td>
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">${pubPbOpadetailDto.regNO}</td> 
        </tr>
        <tr>
            <td style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">事实和理由</td> 
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';word-break:break-all;">${pubPbOpadetailDto.recoverRea}</td>
        </tr>
        <tr>
            ...
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">
                 ${pubPbOpadetailDto.firstOpin} <br>
                 <span style="float:right;">初审人员： ${pubPbOpadetailDto.firstName}</span><br>
                 <span style="float:right;">初审日期： <fmt:formatDate value="${pubPbOpadetailDto.firstDate}" type="date" pattern="yyyy-MM-dd"/></span>
            </td> 
        </tr>
        <tr>
            ...
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';word-break:break-all;">
                 ${pubPbOpadetailDto.auditOpin}<br>
                 <span style="float:right;">审核人员： ${pubPbOpadetailDto.auditName}</span><br>
                 <span style="float:right;">审核日期：<fmt:formatDate value="${pubPbOpadetailDto.auditDate}" type="date" pattern="yyyy-MM-dd"/></span>
            </td> 
        </tr> 
        <tr>
