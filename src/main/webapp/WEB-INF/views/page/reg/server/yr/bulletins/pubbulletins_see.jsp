...
<body class="pd10">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
        ...
        <tr>
            ...
            <td>
                <div class="ipt-box col-12">
                     <select name="bulScope" onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;">
        ...
        <tr>
         ...
         <tr>
            ...
            <td><c:if test="${empty Bulletins.modTime}"></c:if>
