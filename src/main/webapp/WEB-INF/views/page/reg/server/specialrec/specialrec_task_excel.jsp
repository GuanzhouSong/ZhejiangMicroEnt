...
<body class="pd10">
			...
			<tr>
            	...
            	<td>
					...
					<c:if test="${sysUser.userType == '1'}">
						<a href="/reg/server/specialrec/ent/downloadExcel?file_name=specialrecinfo.xls" id="js-download">下载模板</a>
					</c:if>
					<c:if test="${sysUser.userType == '2'}">
						<a href="/syn/server/specialrec/ent/downloadExcel?file_name=specialrecinfo.xls" id="js-download">下载模板</a>
					</c:if>
					</div>
				</td>
           	</tr>
	...
	<script src="/js/reg/server/specialrec/specialrec_task_excel.js"></script>
</body>
</html>