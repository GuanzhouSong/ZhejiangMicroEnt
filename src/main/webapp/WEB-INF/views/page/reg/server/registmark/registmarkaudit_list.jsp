        ...
        <div class="form-list">
            <div class="form-item clearfix">
                ...
                <div class="col-4" id="entName">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt" name="IDCode" value="" placeholder="可输入关键字查询"/>
                        </div>
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                             <input type="text" class="ipt-txt" name="auditorName" value="" placeholder="请输入审核人"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    <script src="<c:url value="/js/reg/server/registmark/registmarkaudit_list_main.js"/>"></script>
</body>
</html>