...
<div class="clearfix">
    ...
    <form id="orderreformsetform">
        ...
        <c:if test="${viewFlag=='1' }">
            ...
            <input type="hidden" name="regOrg" value="${orderReformSet.regOrg}">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mb10">
        ...
        <c:if test="${viewFlag=='1'}">
            <tr>
                ...
                <td colspan="3">
                    <div class="radio-box">
                        <input name="auditStateTem" value="1" type="radio" id="auditStateTemY">同意责令整改
                        <input name="auditStateTem" value="2" type="radio" id="auditStateTemN">退回修改
                        <input name="auditStateTem" value="3" type="radio" id="auditStateTemC">取消责令整改
                    </div>
                </td>
        ...
        <c:if test="${viewFlag=='2'}">
            <c:if test="${orderReformSet.auditState!='4'}">
                ...
                <tr>
                    <td class="bg-gray right" width="12%">审核意见</td>
                    <td colspan="7">
                        <div class="ipt-box col-12">
    ...
    <c:if test="${viewFlag==5&&orderReformSet.auditState=='1'}">
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mb10">
            <tbody>
            <tr>
                <td class="bg-gray right" width="12%"><span class="light">*</span> 中止说明</td>
                <td colspan="5" width="88%">
                    <div class="ipt-box col-12">
            ...
            <tr>
                <td class="bg-gray right" width="12%"><span class="light">*</span> 中止日期</td>
                <td width="40%">
                    <div class="ipt-box col-12">
