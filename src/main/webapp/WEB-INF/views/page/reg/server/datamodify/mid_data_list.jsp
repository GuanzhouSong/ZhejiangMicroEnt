...
<div class="clearfix mb5 mt5">
    <p class="fl"><input id="js-add-ui" type="button" class="btn btn-sm mr5 " value="添加申请">
    <p class="fl"><input  type="button" class="btn btn-sm mr5 " onclick="window.history.go(-1)" value="返回">
</div>
        ...
        <div class="">
            <div class="table-out">
                <table id="user-table" border="0" cellspacing="0" cellpadding="0" class="table-row display nowrap">
                    ...
                    <tr>
                        <th>序号</th>
                        <th>选项<input type="checkbox" id="_checkAll"></th>
                        <th>统一代码/注册号</th>
                        <th>企业名称</th>
                        <th>成立日期</th>
                        <th>企业类型</th>
...
<script src="/js/reg/server/datamodify/mid_data_list.js"></script>
</body>
</html>
