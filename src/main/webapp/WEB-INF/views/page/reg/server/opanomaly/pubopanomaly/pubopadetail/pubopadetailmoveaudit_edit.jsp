...
<div class="main">
    ...
    <form id="pubauditosaveform">
        <div class="listBox2 thBg">
            ...
            <input type="hidden" name="isMove" id="isMove" value="${pubOpaDetail.isMove}">
            ...
            <table class="table-horizontal">
                <tr id="appBasic">
                    ...
                    <td width="150px">
                        <div class="ipt-box"><fmt:formatDate value="${midBaseInfoDto.estDate}" type="date" pattern="yyyy-MM-dd"/></div>
                    </td>
                </tr>
                <tr id="appBasic">
        ...
        <div class="listBox2 thBg">
            ...
            <table class="table-horizontal">
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1" width="100px">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <div class="ipt-box">${pubOpanoMaly.speCauseCN}</div>
                    </td>
                </tr>
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1">
                    ...
                    <td colspan="5">
                        <div class="ipt-box">${pubOpanoMaly.anomalyRea}</div>
                    </td>
                </tr>
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1">
                    ...
                    <td colspan="5">
                        <div class="ipt-box" id="abnTime"><fmt:formatDate value="${pubOpanoMaly.abnTime}" type="date"
                ...
                <tr style="display:<c:if test="${pubOpaDetail.isMove == '2' }">none</c:if> ;">
                    <td class="bg-gray right" valign="middle" class="lb_1">
                        <div class="ipt-box"><font color="red">* </font>移出原因</div>
                    </td>
                    <td colspan="5">
                        <div class="ipt-box">
                            <select id="remExcpres" name="remExcpres" disabled="disabled">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <div class="ipt-box"><textarea id="removeRea" name="removeRea" class="txt_1"
                                                       disabled="disabled">${pubOpaDetail.removeRea}</textarea></div>
                    </td>
                </tr>
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1">
                    ...
                    <td colspan="5">
                        <div class="ipt-box"><textarea id="firstOpin" name="firstOpin" class="txt_1"
                                                       disabled="disabled">${pubOpaDetail.firstOpin}</textarea></div>
                    </td>
                </tr>
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1">
                    ...
                    <td width="180">
                        <div class="ipt-box"><input class="laydate-icon view-opadetail" type="text"
                                                    style="width: 150px;cursor: pointer;" name="remDate" id="remDate"
                                                    value="<fmt:formatDate value="${pubOpaDetail.remDate}" type="date" pattern="yyyy-MM-dd"/>"
                    ...
                    <td class="bg-gray right" valign="middle" class="lb_1">
                        <div class="ipt-box"><font color="red">* </font>决定机关</div>
                    </td>
                    <td>
                        <div class="ipt-box">${pubOpaDetail.reDecOrgCN}</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="180">
                        <div class="ipt-box"><fmt:formatDate value="${pubOpaDetail.firstdate}"
                                                             pattern="yyyy-MM-dd"/></div>
                    </td>
                    ...
                    <td width="170">
                        <div class="ipt-box">${pubOpaDetail.firstName}</div>
                    </td>
                    <td class="bg-gray right" width="130" valign="middle" class="lb_1">
                        <div class="ipt-box">初审部门</div>
                    </td>
                    <td width="250">
                        <div class="ipt-box">${pubOpaDetail.firstDept}</div>
                    </td>
                </tr>
                <tr>
                    <td class="bg-gray right" valign="middle" class="lb_1">
                    ...
                    <td colspan="5">
                        <div class="radio-box" id="unusualRadio">
                            <label class="font-12"><input type="radio" class="view-opadetail" name="auditOpinselect" id="yes" value="1"
                                          <c:if test="${pubOpaDetail.auditState == '1'}">checked</c:if> />${pubOpaDetail.isMove == '1' ? '予以移出经营异常名录' : '予以更正（撤销）'}</label>
                            <label class="font-12"><input type="radio" class="view-opadetail" name="auditOpinselect" id="no" value="2"
                                          <c:if test="${pubOpaDetail.auditState == '2'}">checked</c:if> />${pubOpaDetail.isMove == '1' ? '不予移出经营异常名录' : '不予更正（撤销）'}</label>
                        </div>
                        <div class="ipt-box">
                            <textarea id="auditOpin" name="auditOpin"
                                  class="txt_1 view-opadetail">${pubOpaDetail.auditOpin}</textarea>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="180">
                        <div class="ipt-box" id="auditDate">
                    ...
                    <td width="170">
                        <div class="ipt-box">${pubOpaDetail.auditState == '1' ? pubOpaDetail.auditName : sysUser.realName}</div>
                    </td>
                    <td class="bg-gray right" width="130" valign="middle" class="lb_1">
                        <div class="ipt-box">审核部门</div>
                    </td>
                    <td width="250">
                        <div class="ipt-box">${pubOpaDetail.auditState == '1' ? pubOpaDetail.auditDept : sysUser.departMent.deptName}</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr id="decisionBook" style="display:none;">
                    <td class="bg-gray right"><font color="red">* </font>生成决定书</td>
                    <td colspan="5">
                        <div class="ipt-box"><a style="text-decoration: underline;cursor: pointer;"
                                                id="doEnDecisionBook">生成移出经营异常名录决定书</a></div>
                    </td>
                </tr>
            </table>
        </div>
...
<script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopadetail/pubopadetailmoveaudit_edit.js"/>"></script>
</body>
<script>
    window._CONFIG = {
