...
<div class="clearfix mb5 mt5">
    <p class="fl"><input type="button" class="btn btn-sm mr5  " style="display:none;" id="deleteBtn" value="删除">
...
<script src="/js/reg/server/other/smallsupport/pubotherlicence_list.js"></script>
</body>
</html>