...
<head>
    ...
    <meta charset="utf-8">
    <title>编辑片区商圈页面</title>
    <link rel="stylesheet" href="/css/reg.server.css">
    <link rel="stylesheet" href="/js/lib/ztree/css/zTreeStyle/zTreeStyle.css">
</head>
<body>
<input id="sliceNO" type="hidden" value="${sliceNO}"/>
<input id="sliceNOName" type="hidden" value="${sliceNOName}"/>
...
<div class="layer-bd">
    <div class="mass-distribution pd20">
        ...
        <div class="selected clearfix mb10">
            ...
            <div class="fl" id="sliceNONamediv">${sliceNOName}</div>
        </div>
        <div class="center">
...
<script src="/js/reg/server/registinfo/addsliceno_edit.js"></script>
</body>
</html>