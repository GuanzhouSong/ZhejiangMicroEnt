...
<div class="mod mod-print" style="position:relative; bottom: 30px;">
    <div class="mod-print-hd">
        <p><h1>${pubOpaDetail.deptName}</h1><br></p>
        <p><h1>经营异常名录审批表</h1></p>
    </div> 
    <table class="table-print" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            ...
            <td width="37%" class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">${pubOpaDetail.entName}</td> 
        </tr>
        <tr>
            <td style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">注册号</td>
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">${pubOpaDetail.regNO}</td> 
        </tr>
        <tr>
            <td style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">事实和理由</td> 
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';word-break:break-all;">${pubOpaDetail.removeRea}</td>
        </tr>
        <tr>
            ...
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">
                 ${pubOpaDetail.firstOpin} <br>
                 <span style="float:right;">初审人员： ${pubOpaDetail.firstName}</span><br>
                 <span style="float:right;">初审日期： <fmt:formatDate value="${pubOpaDetail.firstdate}" type="date" pattern="yyyy-MM-dd"/></span>
            </td> 
        </tr>
        <tr>
            ...
            <td class="col-l" style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';word-break:break-all;">
                 ${pubOpaDetail.auditOpin}<br>
                 <span style="float:right;">审核人员： ${pubOpaDetail.auditName}</span><br>
                 <span style="float:right;">审核日期：<fmt:formatDate value="${pubOpaDetail.auditDate}" type="date" pattern="yyyy-MM-dd"/></span>
            </td> 
        </tr> 
        <tr>
