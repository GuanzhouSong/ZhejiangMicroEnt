...
<body class="pd10">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal">
		<input type="hidden" name="UID" value="${SmentBulletins.UID}">
        ...
        <input type="hidden" name="setDeptCode"  value="${userType == 2 ? sysUser.sysDepart.adcode : sysUser.deptCode}" >
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="ipt-box col-12">
                 <input name="title" id="title" placeholder="请输入标题"  class="ipt-txt" value="${SmentBulletins.title}" >                
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="ipt-box col-12">
                <textarea  id="text1"  name="contents" cols="100" rows="10" style="width:700px;height:280px;visibility:hidden;">${SmentBulletins.contents}</textarea>
                </div>
            </td>         
        </tr>
	</table>
