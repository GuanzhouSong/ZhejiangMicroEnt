    ...
    <input type="hidden" name="entTypeCatg" id="entTypeCatg" value="${entBasicInfo.entTypeCatg }"/>
        ...
        <div class="clearfix">
            ...
            <div class="tab-header tab-detail">
                <ul class="clearfix">
                	<li class="tab-selected"><a class="tab-item" href="../../depsyn/search/baseinfo?encryPriPID=${entBasicInfo.encryPriPID }&classFlag=1">基本信息</a>
                    </li>
...
<script src="/js/depsyn/search/cx_xxxq.js"></script>
</body>
</html>