...
<div class="mod clearfix">
    ...
    <div class="main">
        ...
        <div class="pdlr5">
            <div class="tab">
                <li><a href="<c:url value='/depsyn/punish/index'/>" class="cur">行政处罚信息</a></li>
            ...
            <div class="panel-bd">
                <form id="searchForm">
                    <div class="tips">正在填报：行政处罚信息</div>
            ...
            <div id="js-result" class="none">
                ...
                <table cellpadding="0" cellspacing="0" class="table-common">
                    ...
                    <tr>
                        <th width="76">序号</th>
                        <th width="180">处罚机关</th>
                        <th width="192">处罚决定书文号</th>
                        <th width="150">处罚决定书签发日期</th>
                        <th width="186">违法行为类型</th>
                        <th width="186">处罚种类</th>
                    </tr>
                    </thead>
...
<script src="/js/depsyn/punish/punish_main.js"></script>
</body>
</html>