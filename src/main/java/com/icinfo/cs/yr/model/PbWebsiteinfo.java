...
/**
 * 描述:    cs_pb_websiteinfo 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2016年09月12日
 */
@Table(name = "cs_pb_websiteinfo")
public class PbWebsiteinfo implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 5666300071294870772L;
