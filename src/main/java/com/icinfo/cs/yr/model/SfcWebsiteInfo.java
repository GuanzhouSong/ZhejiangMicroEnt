...
/**
 * 描述:    cs_sfc_websiteinfo 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2016年10月08日
 */
@Table(name = "cs_sfc_websiteinfo")
public class SfcWebsiteInfo implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 7963000274864548071L;
