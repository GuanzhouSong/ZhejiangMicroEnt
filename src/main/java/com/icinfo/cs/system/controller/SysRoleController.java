 ...
 */
@Controller
@RequestMapping("/reg/server/sysrole")
public class SysRoleController extends BaseController {
    ...
    @ResponseBody
    public AjaxResult getRoleByRoleId(String roleId) throws Exception { 
        if (StringUtils.isNotEmpty(roleId)) { 
            return AjaxResult.success("查询成功", sysRoleService.selectByPrimaryKey(roleId));
        } 
