           	       	...
           	       	if(jsonObj2!=null){
               		       //用户主键ID
        	       	  		...
        	       	  		if(StringUtil.isNotBlank(djjg)&&StringUtil.isBlank(unifiedUserRecord.getRegOrg())){
           	       		    ...
           	       		    parmMap.put("userType", DBAuthorConstants.USER_TYPE_REG);
           	    		    ...
           	    		    if(sysUserTem==null){
           	    		    	...
           	    		    	//SysUser sysUsers=sysUserService.selectByLoginName(sysUser.getUsername(), DBAuthorConstants.USER_TYPE_REG);
