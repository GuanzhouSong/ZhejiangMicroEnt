...
public class WsMidBaseInfo implements Serializable {
    @Id
    @Column(name = "id")
//    @Before
//    @GeneratedValue(strategy = GenerationType.IDENTITY,generator="select replace(uuid(), '-', '')")
     ...
     * 获取属地机关名称
     *
     * @return LocalRegOrgCodeName - 属地机关名称
     */
     ...
     * 设置属地机关名称
     *
     * @param localRegOrgCodeName 属地机关名称
     */
     ...
     * 获取是否个转企0不是个转企，1是个转企
     *
     * @return IsIndivid - 是否个转企0不是个转企，1是个转企
     */
     ...
     * 设置是否个转企0不是个转企，1是个转企
     *
     * @param isIndivid 是否个转企0不是个转企，1是个转企
     */
