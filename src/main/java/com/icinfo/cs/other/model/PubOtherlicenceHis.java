...
/**
 * 描述:  cs_pub_otherlicence_his 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2016年10月18日
 */
@Table(name = "cs_pub_otherlicence_his")
public class PubOtherlicenceHis implements Serializable {
    /**
     * 主键自增id
     */
    @Id
    ...
    /**
     * 获取类别选择:1:变更,2注销,3被吊销,4,,撤销失效
     *
     * @return LicType - 类别选择:1:变更,2注销,3被吊销,4,,撤销失效
     */
    ...
    /**
     * 设置类别选择:1:变更,2注销,3被吊销,4,,撤销失效
     *
     * @param licType 类别选择:1:变更,2注销,3被吊销,4,,撤销失效
     */
