...
public class SmEntSearch implements Serializable {
     ...
     * 企业名称(分词)
     */
    @Column(name = "EntNameNPPL")
    private String entNameNPPL;
     ...
     * 获取企业名称(分词)
     *
     * @return EntNameNPPL - 企业名称(分词)
     */
    public String getEntNameNPPL() {
        return entNameNPPL;
    }
     ...
     * 设置企业名称(分词)
     *
     * @param entNameNPPL 企业名称(分词)
     */
    public void setEntNameNPPL(String entNameNPPL) {
        this.entNameNPPL = entNameNPPL;
    }
